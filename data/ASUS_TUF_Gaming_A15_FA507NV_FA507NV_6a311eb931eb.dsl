 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/ASUS_TUF_Gaming_A15_FA507NV_FA507NV_6a311eb931eb/ASUS_TUF_Gaming_A15_FA507NV_FA507NV, Sat Aug 22 21:04:51 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CD2F (52527)
 *     Revision         0x02
 *     Checksum         0x1A
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.LEDB, UnknownObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x72212000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x72216000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0x775E1F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x775CFD18, 0x0D)
    ...
    OperationRegion (EXBU, SystemMemory, 0x775E1698, 0x015B)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (KBLS, 0, NotSerialized)
            {
                ...
                DUBF [Zero] = One
                DUBF [One] = KBLM /* \_SB_.PCI0.SBRG.EC0_.KBLM */
                DUBF [0x02] = KBS1 /* \_SB_.PCI0.SBRG.EC0_.KBS1 */
                DUBF [0x03] = KBS2 /* \_SB_.PCI0.SBRG.EC0_.KBS2 */
                DUBF [0x04] = KBS3 /* \_SB_.PCI0.SBRG.EC0_.KBS3 */
                DUBF [0x05] = KBSP /* \_SB_.PCI0.SBRG.EC0_.KBSP */
                DUBF [0x06] = KBBS /* \_SB_.PCI0.SBRG.EC0_.KBBS */
                DUBF [0x07] = Zero
                Return (DUBF) /* \_SB_.PCI0.SBRG.EC0_.KBLS.DUBF */
            }
        ...
        Method (WMNB, 3, Serialized)
        {
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x001200A0))
                {
                    ...
                    ^^PCI0.SBRG.EC0.GMBE = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                    Release (^^PCI0.SBRG.EC0.MUT0)
                    M255 = 0x07
                    M256 = (IIA1 * 0x03E8)
                    ALIB (0x0C, UTDP)
                ...
                {
                    Acquire (^^PCI0.SBRG.EC0.MUT0, 0x0500)
                    ^^PCI0.SBRG.EC0.GMBD = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                    Release (^^PCI0.SBRG.EC0.MUT0)
                    M255 = 0x05
                    M256 = (IIA1 * 0x03E8)
                    ALIB (0x0C, UTDP)
                ...
                {
                    Acquire (^^PCI0.SBRG.EC0.MUT0, 0x0500)
                    ^^PCI0.SBRG.EC0.GMBF = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                    Release (^^PCI0.SBRG.EC0.MUT0)
                    M255 = 0x06
                    M256 = (IIA1 * 0x03E8)
                    ALIB (0x0C, UTDP)
    ...
    Scope (_SB.I2CB)
    {
        If ((TPID == 0x03))
        {
            Device (TPD1)
            {
                Name (_HID, "ASUF1204")  // _HID: Hardware ID
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2CB.TPD1._CRS.RBUF */
                }
        ...
        Else
        {
            Device (TPD2)
            {
                Name (_HID, "ASUP1205")  // _HID: Hardware ID
                Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
                Name (_UID, 0x06)  // _UID: Unique ID
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2CB.TPD2._CRS.RBUF */
                }
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (UPMI)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP19.XHC2.RHUB.PRT1.UPMI.UPC1 */
                    }
    ...
    Scope (_SB.I2CA)
    {
        Device (SMKB)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CA.SMKB._CRS.RBUF */
            }
        ...
        Scope (GPP6)
        {
            Device (WLAN)
            {
                ...
                Method (RWSI, 0, Serialized)
                {
                    ...
                    Return (RWSY) /* \_SB_.PCI0.GPP6.WLAN.RWSI.RWSY */
                }
            ...
            Method (WMAA, 3, Serialized)
            {
                ...
                Switch (Arg1)
                {
                    Case (One)
                    {
                        If ((MODF == Zero))
                        {
                            LEDB = ^^SBRG.EC0.GBLD /* \_SB_.PCI0.SBRG.EC0_.GBLD */
                            Return (LEDB) /* \_SB_.PCI0.AWMI.WMAA.LEDB */
                        }
                        ElseIf ((MODF == One))
                        {
                            ^^SBRG.EC0.SBLD = LEDB /* \_SB_.PCI0.AWMI.WMAA.LEDB */
                            Return (Zero)
                        }
                        ElseIf ((MODF == 0x02))
                        {
