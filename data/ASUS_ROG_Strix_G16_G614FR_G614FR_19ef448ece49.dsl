 ...
 *
 * Disassembly of /tmp/tmp.XHgqSGhPB4/ROG_Strix_G16_G614FR_G614FR_19ef448ece49_16/ROG_Strix_G16_G614FR_G614FR, Tue Jul 28 17:23:18 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000116F8 (71416)
 *     Revision         0x02
 *     Checksum         0xC9
 *     OEM ID           "_ASUS_"
...
{
    External (**XC, UnknownObj)
    External (_SB_.ALIB, MethodObj)    // 2 Arguments
    External (_SB_.APTS, MethodObj)    // 1 Arguments
    External (_SB_.ATKD.MAKY, UnknownObj)
    External (_SB_.ATKD.WMNB.ABOT, UnknownObj)
    External (_SB_.ATKD.WMNB.ISOD, UnknownObj)
    External (_SB_.ATKD.WMNB.RBLS, UnknownObj)
    ...
    External (ABOT, IntObj)
    External (AFN4, MethodObj)    // 1 Arguments
    External (BH30, UnknownObj)
    ...
    OperationRegion (GNVS, SystemMemory, 0x72735C98, 0x04)
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            ...
            Else
            {
                ...
                ElseIf ((TTPF == Zero))
                {
                    If ((AMDT == 0x02))
                    {
                        CreateDWordField (CRSI, \_SB.TPM._Y26._BAS, HSPF)  // _BAS: Base Address
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("d2a8c3e8-4b69-4f00-82bd-fe8607803aa7") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == 0x04))
                    {
                        Return (Buffer (0x08)
                        {
                             0x00, 0xE0, 0x4C, 0x00, 0x01, 0x6C, 0x58, 0x5A   // ..L..lXZ
                        })
                    }
    ...
    Scope (_SB.I2CD)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "10431054")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
    ...
    OperationRegion (EXBU, SystemMemory, 0x72735698, 0x01DF)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        ...
        OperationRegion (CMS2, SystemMemory, 0xFED80600, 0xFF)
        ...
        Device (BAT0)
        {
            ...
            {
                M460 ("IEC-ASL-\\_SB.BATT._BTP Arg0 = 0x%X\n", ToInteger (Arg0), Zero, Zero, Zero, Zero, Zero)
                If (ECOK)
                {
                    Acquire (MUEX, 0xFFFF)
                    Local0 = Arg0
    ...
    Scope (_SB)
    {
        Device (FAN0)
        {
            ...
            Method (CRNF, 0, NotSerialized)
            {
                ...
                Local1 &= 0xFFFF0000
                Local0 |= Local1
                ^^PCI0.SBRG.SEWC (Zero, Local0, 0x85)
            }
    ...
    Scope (_SB.ATKD)
    {
        Method (WMNB, 3, Serialized)
        {
            ...
            If ((Local0 == 0x53545344))
            {
                ...
                If ((IIA0 == 0x00100071))
                {
                    Return ((0x00010000 | ^^PCI0.SBRG.COPK))
                }

                If ((IIA0 == 0x00100072))
                {
                    Local0 = ^^PCI0.SBRG.CONH /* \_SB_.PCI0.SBRG.CONH */
                    Local1 = ^^PCI0.SBRG.CONL /* \_SB_.PCI0.SBRG.CONL */
                    Local0 <<= 0x08
                    Local0 |= Local1
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x00090031))
                {
                    ...
                    ^^PCI0.SBRG.ADTM (Zero)
                    Local0 = (IIA1 & 0xFFFF)
                    Return (^^PCI0.SBRG.SEWC (IIA0, Local0, 0x89))
                }
    ...
    Name (DRP9, Buffer (0xE9)
    {
        /* 0000 */  0xFA, 0x5B, 0x6C, 0x4E, 0x97, 0xC4, 0xA8, 0x0A,  // .[lN....
        /* 0008 */  0x52, 0x44, 0xE9, 0x00, 0x00, 0x00, 0x00, 0x01,  // RD......
        /* 0010 */  0x00, 0x00, 0x00, 0x00, 0xDE, 0x10, 0x00, 0x00,  // ........
        /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
        /* 0020 */  0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x34, 0x00,  // ......4.
        /* 0028 */  0x00, 0x00, 0x01, 0x00, 0x47, 0x00, 0x00, 0x00,  // ....G...
        /* 0030 */  0x02, 0x00, 0x45, 0x00, 0x00, 0x00, 0x03, 0x00,  // ..E.....
        /* 0038 */  0x99, 0x00, 0x00, 0x00, 0x04, 0x00, 0x97, 0x00,  // ........
        /* 0040 */  0x00, 0x00, 0x05, 0x00, 0x95, 0x00, 0x00, 0x00,  // ........
        /* 0048 */  0x06, 0x00, 0x93, 0x00, 0x00, 0x00, 0x07, 0x00,  // ........
        /* 0050 */  0x91, 0x00, 0x00, 0x00, 0x08, 0x00, 0x8F, 0x00,  // ........
        /* 0058 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xD9, 0x1C,  // ........
        /* 0060 */  0x04, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,  // ........
        /* 0068 */  0x41, 0x5D, 0xC9, 0x00, 0x01, 0x24, 0x2E, 0x00,  // A]...$..
        /* 0070 */  0x02, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x01,  // ........
        /* 0078 */  0x00, 0x00, 0x00, 0xD9, 0x1C, 0x04, 0x00, 0x00,  // ........
        /* 0080 */  0x00, 0x02, 0x00, 0x00, 0x00, 0xE0, 0x7C, 0x97,  // ......|.
        /* 0088 */  0x01, 0xC4, 0xD5, 0xC4, 0x44, 0x00, 0x00, 0x00,  // ....D...
        /* 0090 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00,  // .....8..
        /* 0098 */  0x00, 0x33, 0x00, 0x30, 0x00, 0x30, 0x00, 0x2A,  // .3.0.0.*
        /* 00A0 */  0x00, 0x38, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30,  // .8.0.0.0
        /* 00A8 */  0x00, 0x3B, 0x00, 0x32, 0x00, 0x34, 0x00, 0x30,  // .;.2.4.0
        /* 00B0 */  0x00, 0x2A, 0x00, 0x31, 0x00, 0x30, 0x00, 0x30,  // .*.1.0.0
        /* 00B8 */  0x00, 0x30, 0x00, 0x30, 0x00, 0x3B, 0x00, 0x36,  // .0.0.;.6
        /* 00C0 */  0x00, 0x30, 0x00, 0x2A, 0x00, 0x34, 0x00, 0x30,  // .0.*.4.0
        /* 00C8 */  0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x00,  // .0.0.0..
    ...
    {
        /* 0000 */  0x9C, 0xC1, 0x14, 0x32, 0xE8, 0xCF, 0xC2, 0xA8,  // ...2....
        ...
        /* 0050 */  0x4C, 0x5A, 0x4F, 0x4A, 0x51, 0x44, 0x53, 0x59,  // LZOJQDSY
        /* 0058 */  0x55, 0x4B, 0x41, 0x46, 0x57, 0x51, 0x44, 0x42,  // UKAFWQDB
        /* 0060 */  0x43, 0x47, 0x20, 0x2D, 0x20, 0x47, 0x33, 0x21,  // CG - G3!
        /* 0068 */  0x5A, 0x5F, 0x53, 0x22, 0x48, 0x57, 0x49, 0x53,  // Z_S"HWIS
        /* 0070 */  0x47, 0x51, 0x5C, 0x2B, 0x51, 0x5B, 0x37, 0x5B,  // GQ\+Q[7[
        /* 0078 */  0x3B, 0x24, 0x30, 0x5F, 0x2C, 0x4C, 0x25, 0x2E,  // ;$0_,L%.
    ...
    {
        /* 0000 */  0x96, 0x8C, 0x36, 0xAC, 0xD0, 0xB2, 0xDC, 0xA7,  // ..6.....
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0050 */  0x57, 0x5A, 0x59, 0x44, 0x50, 0x5A, 0x4F, 0x41,  // WZYDPZOA
        /* 0058 */  0x49, 0x54, 0x41, 0x4C, 0x53, 0x43, 0x59, 0x59,  // ITALSCYY
        /* 0060 */  0x44, 0x58, 0x20, 0x2D, 0x20, 0x58, 0x5B, 0x40,  // DX - X[@
        /* 0068 */  0x36, 0x45, 0x53, 0x38, 0x24, 0x39, 0x21, 0x40,  // 6ES8$9!@
        /* 0070 */  0x44, 0x28, 0x2D, 0x30, 0x3A, 0x2F, 0x42, 0x57,  // D(-0:/BW
        /* 0078 */  0x47, 0x4E, 0x27, 0x32, 0x2E, 0x25, 0x2D, 0x2C,  // GN'2.%-,
    ...
    {
        /* 0000 */  0x86, 0x17, 0x50, 0x7C, 0xFD, 0xE5, 0x60, 0xE5,  // ..P|..`.
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0050 */  0x5A, 0x52, 0x58, 0x49, 0x59, 0x53, 0x4D, 0x4D,  // ZRXIYSMM
        /* 0058 */  0x57, 0x59, 0x50, 0x4C, 0x4F, 0x55, 0x41, 0x4D,  // WYPLOUAM
        /* 0060 */  0x53, 0x44, 0x20, 0x2D, 0x20, 0x35, 0x37, 0x24,  // SD - 57$
        /* 0068 */  0x54, 0x24, 0x32, 0x58, 0x45, 0x5B, 0x44, 0x2D,  // T$2XE[D-
        /* 0070 */  0x2E, 0x31, 0x35, 0x58, 0x55, 0x50, 0x56, 0x24,  // .15XUPV$
        /* 0078 */  0x55, 0x5D, 0x57, 0x20, 0x27, 0x33, 0x52, 0x29,  // U]W '3R)
        /* 0080 */  0x3C, 0x20, 0x2D, 0x20, 0x43, 0x6F, 0x70, 0x79,  // < - Copy
        /* 0088 */  0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x32, 0x30,  // right 20
        /* 0090 */  0x32, 0x33, 0x20, 0x4E, 0x56, 0x49, 0x44, 0x49,  // 23 NVIDI
        /* 0098 */  0x41, 0x20, 0x43, 0x6F, 0x72, 0x70, 0x6F, 0x72,  // A Corpor
        /* 00A0 */  0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x41, 0x6C,  // ation Al
    ...
    {
        /* 0000 */  0xF4, 0x96, 0x43, 0xBD, 0xC2, 0x58, 0x5A, 0x9F,  // ..C..XZ.
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0038 */  0x6E, 0x63, 0x20, 0x52, 0x65, 0x61, 0x64, 0x79,  // nc Ready
        /* 0040 */  0x20, 0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72,  //  Platfor
        /* 0048 */  0x6D, 0x20, 0x66, 0x6F, 0x72, 0x20, 0x51, 0x4B,  // m for QK
        /* 0050 */  0x4A, 0x45, 0x42, 0x56, 0x4A, 0x55, 0x45, 0x4D,  // JEBVJUEM
        /* 0058 */  0x58, 0x56, 0x5A, 0x45, 0x42, 0x56, 0x57, 0x41,  // XVZEBVWA
        /* 0060 */  0x49, 0x45, 0x20, 0x2D, 0x20, 0x32, 0x3F, 0x35,  // IE - 2?5
        /* 0068 */  0x2E, 0x4B, 0x27, 0x56, 0x44, 0x43, 0x36, 0x47,  // .K'VDC6G
        /* 0070 */  0x32, 0x5D, 0x48, 0x57, 0x4D, 0x27, 0x3B, 0x47,  // 2]HWM';G
        /* 0078 */  0x2F, 0x29, 0x4A, 0x28, 0x2A, 0x2B, 0x4A, 0x41,  // /)J(*+JA
        /* 0080 */  0x36, 0x20, 0x2D, 0x20, 0x43, 0x6F, 0x70, 0x79,  // 6 - Copy
        /* 0088 */  0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x32, 0x30,  // right 20
        /* 0090 */  0x32, 0x33, 0x20, 0x4E, 0x56, 0x49, 0x44, 0x49,  // 23 NVIDI
        /* 0098 */  0x41, 0x20, 0x43, 0x6F, 0x72, 0x70, 0x6F, 0x72,  // A Corpor
        /* 00A0 */  0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x41, 0x6C,  // ation Al
    ...
    Name (VKP4, Buffer (0x04)
    {
         0x02, 0x00, 0x00, 0x80                           // ....
    })
    Name (VKP5, Buffer (0x04)
    {
         0x02, 0x00, 0x00, 0x80                           // ....
    })
    Name (VKP6, Buffer (0xC9)
    {
        /* 0000 */  0xF8, 0xF9, 0x05, 0x99, 0xF4, 0xB5, 0x2D, 0xDA,  // ......-.
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0038 */  0x6E, 0x63, 0x20, 0x52, 0x65, 0x61, 0x64, 0x79,  // nc Ready
        /* 0040 */  0x20, 0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72,  //  Platfor
        /* 0048 */  0x6D, 0x20, 0x66, 0x6F, 0x72, 0x20, 0x5A, 0x55,  // m for ZU
        /* 0050 */  0x56, 0x50, 0x54, 0x59, 0x43, 0x45, 0x5A, 0x50,  // VPTYCEZP
        /* 0058 */  0x5A, 0x4E, 0x4A, 0x4D, 0x44, 0x5A, 0x52, 0x56,  // ZNJMDZRV
        /* 0060 */  0x42, 0x43, 0x20, 0x2D, 0x20, 0x4F, 0x32, 0x5F,  // BC - O2_
        /* 0068 */  0x49, 0x23, 0x29, 0x5D, 0x40, 0x54, 0x5F, 0x20,  // I#)]@T_ 
        /* 0070 */  0x2B, 0x4F, 0x4F, 0x53, 0x5E, 0x51, 0x58, 0x3F,  // +OOS^QX?
        /* 0078 */  0x51, 0x51, 0x4C, 0x22, 0x5B, 0x3D, 0x4F, 0x3D,  // QQL"[=O=
        /* 0080 */  0x48, 0x20, 0x2D, 0x20, 0x43, 0x6F, 0x70, 0x79,  // H - Copy
        /* 0088 */  0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x32, 0x30,  // right 20
        /* 0090 */  0x32, 0x33, 0x20, 0x4E, 0x56, 0x49, 0x44, 0x49,  // 23 NVIDI
        /* 0098 */  0x41, 0x20, 0x43, 0x6F, 0x72, 0x70, 0x6F, 0x72,  // A Corpor
        /* 00A0 */  0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x41, 0x6C,  // ation Al
    ...
    {
        /* 0000 */  0xEA, 0x43, 0xAD, 0x77, 0x2C, 0x2B, 0x2C, 0x34,  // .C.w,+,4
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0038 */  0x6E, 0x63, 0x20, 0x52, 0x65, 0x61, 0x64, 0x79,  // nc Ready
        /* 0040 */  0x20, 0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72,  //  Platfor
        /* 0048 */  0x6D, 0x20, 0x66, 0x6F, 0x72, 0x20, 0x55, 0x4A,  // m for UJ
        /* 0050 */  0x5A, 0x4A, 0x46, 0x50, 0x51, 0x4B, 0x43, 0x44,  // ZJFPQKCD
        /* 0058 */  0x55, 0x44, 0x54, 0x48, 0x4A, 0x53, 0x41, 0x43,  // UDTHJSAC
        /* 0060 */  0x4E, 0x49, 0x20, 0x2D, 0x20, 0x5D, 0x47, 0x5D,  // NI - ]G]
        /* 0068 */  0x57, 0x2D, 0x40, 0x32, 0x27, 0x25, 0x56, 0x27,  // W-@2'%V'
        /* 0070 */  0x2C, 0x3F, 0x27, 0x33, 0x36, 0x37, 0x21, 0x3F,  // ,?'367!?
        /* 0078 */  0x2A, 0x45, 0x55, 0x4B, 0x4F, 0x2D, 0x45, 0x3A,  // *EUKO-E:
        /* 0080 */  0x4E, 0x20, 0x2D, 0x20, 0x43, 0x6F, 0x70, 0x79,  // N - Copy
        /* 0088 */  0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x32, 0x30,  // right 20
        /* 0090 */  0x32, 0x33, 0x20, 0x4E, 0x56, 0x49, 0x44, 0x49,  // 23 NVIDI
        /* 0098 */  0x41, 0x20, 0x43, 0x6F, 0x72, 0x70, 0x6F, 0x72,  // A Corpor
        /* 00A0 */  0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x41, 0x6C,  // ation Al
    ...
    {
        /* 0000 */  0x33, 0x53, 0x81, 0xA5, 0xA7, 0xDC, 0xCE, 0x5A,  // 3S.....Z
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0038 */  0x6E, 0x63, 0x20, 0x52, 0x65, 0x61, 0x64, 0x79,  // nc Ready
        /* 0040 */  0x20, 0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72,  //  Platfor
        /* 0048 */  0x6D, 0x20, 0x66, 0x6F, 0x72, 0x20, 0x50, 0x56,  // m for PV
        /* 0050 */  0x5A, 0x44, 0x42, 0x4F, 0x42, 0x44, 0x53, 0x49,  // ZDBOBDSI
        /* 0058 */  0x52, 0x4D, 0x42, 0x56, 0x4D, 0x4C, 0x5A, 0x4B,  // RMBVMLZK
        /* 0060 */  0x47, 0x46, 0x20, 0x2D, 0x20, 0x4D, 0x39, 0x2F,  // GF - M9/
        /* 0068 */  0x20, 0x41, 0x5D, 0x28, 0x4E, 0x5D, 0x30, 0x59,  //  A](N]0Y
        /* 0070 */  0x49, 0x5B, 0x42, 0x51, 0x57, 0x57, 0x40, 0x41,  // I[BQWW@A
        /* 0078 */  0x56, 0x28, 0x3F, 0x54, 0x23, 0x24, 0x58, 0x40,  // V(?T#$X@
    ...
    Name (VKP9, Buffer (0xC9)
    {
        /* 0000 */  0x9A, 0xBA, 0x12, 0xBD, 0x1D, 0xEB, 0x71, 0x98,  // ......q.
        /* 0008 */  0x4B, 0x56, 0xC9, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
        /* 0010 */  0x39, 0x31, 0x34, 0x35, 0x37, 0x32, 0x32, 0x32,  // 91457222
        /* 0018 */  0x37, 0x37, 0x31, 0x36, 0x47, 0x65, 0x6E, 0x75,  // 7716Genu
        /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
        ...
        /* 0038 */  0x6E, 0x63, 0x20, 0x52, 0x65, 0x61, 0x64, 0x79,  // nc Ready
        /* 0040 */  0x20, 0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72,  //  Platfor
        /* 0048 */  0x6D, 0x20, 0x66, 0x6F, 0x72, 0x20, 0x4D, 0x44,  // m for MD
        /* 0050 */  0x45, 0x57, 0x4D, 0x59, 0x45, 0x48, 0x56, 0x50,  // EWMYEHVP
        /* 0058 */  0x55, 0x51, 0x4D, 0x4B, 0x45, 0x4B, 0x51, 0x55,  // UQMKEKQU
        /* 0060 */  0x44, 0x4B, 0x20, 0x2D, 0x20, 0x38, 0x39, 0x5B,  // DK - 89[
        /* 0068 */  0x48, 0x3D, 0x2C, 0x55, 0x55, 0x26, 0x2E, 0x34,  // H=,UU&.4
        /* 0070 */  0x32, 0x51, 0x50, 0x33, 0x3D, 0x2C, 0x41, 0x52,  // 2QP3=,AR
        /* 0078 */  0x4E, 0x46, 0x21, 0x56, 0x58, 0x39, 0x3D, 0x42,  // NF!VX9=B
        /* 0080 */  0x46, 0x20, 0x2D, 0x20, 0x43, 0x6F, 0x70, 0x79,  // F - Copy
        /* 0088 */  0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x32, 0x30,  // right 20
        /* 0090 */  0x32, 0x33, 0x20, 0x4E, 0x56, 0x49, 0x44, 0x49,  // 23 NVIDI
        /* 0098 */  0x41, 0x20, 0x43, 0x6F, 0x72, 0x70, 0x6F, 0x72,  // A Corpor
        /* 00A0 */  0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x41, 0x6C,  // ation Al
