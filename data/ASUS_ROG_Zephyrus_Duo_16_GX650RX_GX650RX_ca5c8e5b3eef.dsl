 ...
 *
 * Disassembly of /tmp/tmp.e5oIvBp5IU/ROG_Zephyrus_Duo_16_GX650RX_GX650RX_ca5c8e5b3eef/ROG_Zephyrus_Duo_16_GX650RX_GX650RX, Tue Sep 15 09:39:50 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FBC0 (64448)
 *     Revision         0x02
 *     Checksum         0xD1
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB3E1D000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB3E21000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB91A6F98)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB91A9D18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xB91AA000, 0x0100)
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x0005001C))
                    {
                        If (((LCDV == 0xE5090A19) | (LCDV == 0xE5090A45)))
                        {
                            SMIF = 0x09
                            ASMI (0x02)
                            Name (UFSW, Buffer (0x08)
                            {
                                 0x00, 0x00, 0x01, 0x00, 0x78, 0x00, 0xF0, 0x00   // ....x...
                            })
                            If ((ALPR == One))
                            {
                                UFSW [Zero] = One
                                Return (UFSW) /* \_SB_.ATKD.WMNB.UFSW */
                            }
                    ...
                    If ((IIA0 == 0x00010031))
                    {
                        ...
                        While ((Local2 < 0x02))
                        {
                            ...
                            If ((Local3 != 0xFFFFFFFF))
                            {
                                ...
                                {
                                    SGOV (Zero, Local3, One)
                                }
                                Else
                                {
                                    SGOV (Zero, Local3, Zero)
                                }
                            }
