...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    OperationRegion (EXBU, SystemMemory, 0x6E9D6F18, 0x0053)
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x00090120))
                {
                    ...
                    If ((IIA1 == Zero))
                    {
                        ...
                        UMFG = Zero
                        GPCE = 0x02
                        Notify (^^PCI0.GPP9.PEGP, Zero) // Bus Check
