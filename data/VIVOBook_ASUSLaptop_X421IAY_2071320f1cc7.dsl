 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/VivoBook_ASUSLaptop_X421IAY_2071320f1cc7/VivoBook_ASUSLaptop_X421IAY, Sat Aug 22 21:12:54 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B15B (45403)
 *     Revision         0x02
 *     Checksum         0x30
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC728000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC72C000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC950F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xCC93A000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (AWLN, SystemMemory, AWLB, 0x43)
