 ...
 *
 * Disassembly of /tmp/tmp.QlQmcYvava/Galith_901af16a499d/Galith, Mon May 11 09:48:56 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00003619 (13849)
 *     Revision         0x02
 *     Checksum         0x8A
 *     OEM ID           "COREv4"
...
DefinitionBlock ("", "DSDT", 2, "COREv4", "COREBOOT", 0x20110725)
{
    ...
    Scope (\)
    {
        OperationRegion (GNVS, SystemMemory, 0x76FFE700, 0x38)
    }
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Scope (\_SB.PCI0)
            {
                ...
                Method (OFST, 1, NotSerialized)
                {
                    Return ((ICKB + (Arg0 * 0x0C)))
                }

                Method (RAOW, 3, Serialized)
                {
                    OperationRegion (ICLK, SystemMemory, OFST (Arg0), 0x04)
            ...
            Device (GPIO)
            {
                Name (_HID, "INT34C8")  // _HID: Hardware ID
                Name (_UID, Zero)  // _UID: Unique ID
            ...
            {
                If (((Arg0 >= Zero) && (Arg0 <= 0x5B)))
                {
                    Local0 = 0x6E
                    Local1 = (Arg0 - Zero)
                }

                If (((Arg0 >= 0x5C) && (Arg0 <= 0xC2)))
                {
                    Local0 = 0x6D
                    Local1 = (Arg0 - 0x5C)
                }

                If (((Arg0 >= 0xC3) && (Arg0 <= 0xD1)))
                {
                    Local0 = 0x6C
                    Local1 = (Arg0 - 0xC3)
                }

                If (((Arg0 >= 0xD2) && (Arg0 <= 0xEF)))
                {
                    Local0 = 0x6A
                    Local1 = (Arg0 - 0xD2)
                }

                If (((Arg0 >= 0xF0) && (Arg0 <= 0xF7)))
                {
                    Local0 = 0x69
                    Local1 = (Arg0 - 0xF0)
                }

                Local2 = ((PCRB (Local0) + 0x0600) + (Local1 * 0x10))
                Return (Local2)
            }
            ...
            Scope (\_SB.PCI0)
            {
                Device (PMC)
                {
                    ...
                    Name (_DDN, "Intel(R) Jasper Lake IPC Controller")  // _DDN: DOS Device Name
                    Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
                    {
                        Memory32Fixed (ReadWrite,
            ...
            Device (XHCI)
            {
                ...
                {
                    UWES ((U2WE & 0xFF), 0x0480, XMEM)
                    UWES ((U3WE & 0x3F), 0x0500, XMEM)
                }
