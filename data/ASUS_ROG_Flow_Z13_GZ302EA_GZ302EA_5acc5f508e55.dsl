 ...
 *
 * Disassembly of /tmp/tmp.W11lRqaUXQ/ROG_Flow_Z13_GZ302EA_GZ302EA_5acc5f508e55/ROG_Flow_Z13_GZ302EA_GZ302EA, Tue Jun 16 18:55:06 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001389B (80027)
 *     Revision         0x02
 *     Checksum         0xD3
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Scope (_SB.I2CC)
    {
        Device (PS8)
        {
            Name (_HID, "PX883508")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
        ...
        Device (PSB)
        {
            Name (_HID, "PS88350B")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSB_._CRS.RBUF */
            }
        ...
        Device (PSC)
        {
            Name (_HID, "PS88350C")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSC_._CRS.RBUF */
            }
        ...
        Device (PSD)
        {
            Name (_HID, "PS88350D")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSD_._CRS.RBUF */
            }
        ...
        Device (PSE)
        {
            Name (_HID, "PS88350E")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSE_._CRS.RBUF */
            }
        ...
        Device (PS10)
        {
            Name (_HID, "PX883510")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS10._CRS.RBUF */
            }
        ...
        Device (PS12)
        {
            Name (_HID, "PS883512")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS12._CRS.RBUF */
            }
        ...
        Device (PS13)
        {
            Name (_HID, "PS883513")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS13._CRS.RBUF */
            }
        ...
        Device (PS14)
        {
            Name (_HID, "PS883514")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS14._CRS.RBUF */
            }
        ...
        Device (PS15)
        {
            Name (_HID, "PS883515")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS15._CRS.RBUF */
            }
        ...
        Device (PS16)
        {
            Name (_HID, "PS883516")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS16._CRS.RBUF */
            }
        ...
        Device (PS17)
        {
            Name (_HID, "PS883517")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    I2cSerialBusV2 (0x0017, ControllerInitiated, 0x00061A80,
                        AddressingMode7Bit, "\\_SB.I2CC",
                        0x00, ResourceConsumer, , Exclusive,
                        )
                })
                Return (RBUF) /* \_SB_.I2CC.PS17._CRS.RBUF */
            }
        ...
        Device (PS18)
        {
            Name (_HID, "PX883518")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS18._CRS.RBUF */
            }
        ...
        Device (PS19)
        {
            Name (_HID, "PS883519")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS19._CRS.RBUF */
            }
        ...
        Device (PS1A)
        {
            Name (_HID, "PS88351A")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1A._CRS.RBUF */
            }
        ...
        Device (PS1B)
        {
            Name (_HID, "PS88351B")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1B._CRS.RBUF */
            }
        ...
        Device (PS1C)
        {
            Name (_HID, "PS88351C")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1C._CRS.RBUF */
            }
        ...
        Device (PS1D)
        {
            Name (_HID, "PS88351D")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1D._CRS.RBUF */
            }
        ...
        Device (PS1E)
        {
            Name (_HID, "PS88351E")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1E._CRS.RBUF */
            }
        ...
        Device (PS1F)
        {
            Name (_HID, "PS88351F")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS1F._CRS.RBUF */
            }
        ...
        Device (PS20)
        {
            Name (_HID, "PX883520")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS20._CRS.RBUF */
            }
        ...
        Device (PS21)
        {
            Name (_HID, "PS883521")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS21._CRS.RBUF */
            }
        ...
        Device (PS22)
        {
            Name (_HID, "PS883522")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS22._CRS.RBUF */
            }
        ...
        Device (PS23)
        {
            Name (_HID, "PS883523")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS23._CRS.RBUF */
            }
        ...
        Device (PS24)
        {
            Name (_HID, "PS883524")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS24._CRS.RBUF */
            }
        ...
        Device (PS25)
        {
            Name (_HID, "PS883525")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS25._CRS.RBUF */
            }
        ...
        Device (PS26)
        {
            Name (_HID, "PS883526")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS26._CRS.RBUF */
            }
        ...
        Device (PS27)
        {
            Name (_HID, "PS883527")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS27._CRS.RBUF */
            }
