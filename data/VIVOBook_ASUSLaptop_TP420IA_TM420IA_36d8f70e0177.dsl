 ...
 *
 * Disassembly of /tmp/tmp.27CHi3cjOM/VivoBook_ASUSLaptop_TP420IA_TM420IA_36d8f70e0177/VivoBook_ASUSLaptop_TP420IA_TM420IA, Tue Jun 30 08:46:52 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000BE0B (48651)
 *     Revision         0x02
 *     Checksum         0x17
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCBB0B000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCBB0F000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0xCC4DEF98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (RDHW, Zero)
    Name (CNSB, One)
    Name (CRBR, 0xCC4DE018)
    OperationRegion (CRBN, SystemMemory, CRBR, 0x09)
        ...
        Device (RHUB)
        {
            ...
            Device (PRT3)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x10, 0x0C, 0x80, 0x01, 0x01, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
        ...
        Device (RHUB)
        {
            ...
            Device (PRT4)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x10, 0x0C, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
        ...
        Scope (GPP1)
        {
            ...
            Device (WLAN)
            {
                ...
                Method (WRDD, 0, Serialized)
                {
                    ...
                    Return (WRDX) /* \_SB_.PCI0.GPP1.WLAN.WRDX */
                }
                ...
                Method (RWSI, 0, Serialized)
                {
                    ...
                    Return (RWS1) /* \_SB_.PCI0.GPP1.WLAN.RWSI.RWS1 */
                }
            }
        }
    ...
    OperationRegion (EXBU, SystemMemory, 0xCC4DEA18, 0x004A)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            OperationRegion (EC62, SystemIO, 0x62, 0x06)
            ...
            Scope (\_SB.PCI0.SBRG.EC0)
            {
                ...
                Device (BATT)
                {
                    ...
                    Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                    {
                        ...
                        PKG1 [0x02] = B1RC /* \_SB_.PCI0.SBRG.EC0_.B1RC */
    ...
    Scope (\)
    {
        ...
        Method (SLKI, 1, NotSerialized)
        {
            ...
            If (Local0)
            {
                ...
                \_SB.PCI0.SBRG.EC0.KBLL = Local1
                KBLV = Local1
            }
            Else
            {
                \_SB.PCI0.SBRG.EC0.KBLL = Zero
            }
    ...
    Scope (_SB)
    {
        ThermalZone (TZ0)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                {
                    Local0 = ^^PCI0.SBRG.EC0.ECRD (RefOf (^^PCI0.SBRG.EC0.PECV))
            ...
            Method (_HOT, 0, Serialized)  // _HOT: Hot Temperature
            {
                If (^^PCI0.SBRG.EC0.ECAV)
                {
                    Local0 = ^^PCI0.SBRG.EC0.ECRD (RefOf (^^PCI0.SBRG.EC0.THOT))
                    If ((Local0 != Zero))
                    {
