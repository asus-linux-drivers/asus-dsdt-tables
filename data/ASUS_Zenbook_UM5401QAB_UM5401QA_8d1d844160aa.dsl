 ...
 *
 * Disassembly of /tmp/tmp.27CHi3cjOM/Zenbook_UM5401QAB_UM5401QA_8d1d844160aa/Zenbook_UM5401QAB_UM5401QA, Tue Jun 30 08:47:54 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC731000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC735000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC966918)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC966C18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC954000, 0x0100)
