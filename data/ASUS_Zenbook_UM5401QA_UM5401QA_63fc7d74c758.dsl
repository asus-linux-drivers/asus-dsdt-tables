 ...
 *
 * Disassembly of /tmp/tmp.t5oaJsGYl4/Zenbook_UM5401QA_UM5401QA
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CA3C (51772)
 *     Revision         0x02
 *     Checksum         0x03
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC722C18, 0x0E)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC723000, 0x0100)
        ...
        Device (ETPD)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                Name (SBFI, Buffer (0x41)
                {
                    ...
                    /* 0030 */  0x00, 0x00, 0x00, 0x10, 0x00, 0x5C, 0x5F, 0x53,  // .....\_S
        ...
        Device (TPL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (SBFI, Buffer (0x41)
                {
                    ...
                    /* 0020 */  0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x00,  // ........
                    /* 0028 */  0x00, 0x00, 0x17, 0x00, 0x00, 0x19, 0x00, 0x23,  // .......#
