 ...
 *
 * Disassembly of /tmp/tmp.piOeGN5qP1/Vivobook_Go_E1404FA_E1404FA_e12c5e470b65/Vivobook_Go_E1404FA_E1404FA, Tue Jul 14 17:23:21 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00012C9E (76958)
 *     Revision         0x02
 *     Checksum         0x21
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB4CB0000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB4CB4000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB9F47F98)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB9F5AF18, 0x07)
    ...
    Scope (_SB.PCI0)
    {
        Device (PS2K)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Local0 = PKBC /* \_SB_.PCI0.PS2K.PKBC */
                If ((Local0 & One))
                {
                    Local0 = PKBD /* \_SB_.PCI0.PS2K.PKBD */
                }
            ...
            Device (PRT2)
            {
                ...
                Device (PRT4)
                {
                    ...
                    Name (PLD1, Package (0x01)
                    {
                        ...
                        {
                            /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                            /* 0008 */  0x00, 0x00, 0x80, 0x02, 0x03, 0x00, 0x00, 0x00,  // ........
                            /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                        }
                    })
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x01, 0x00, 0x80, 0x04, 0x03, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
            ...
            Device (PRT2)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x01, 0x00, 0x00, 0x05, 0x03, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
            ...
            Device (PRT3)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x01, 0x00, 0x80, 0x05, 0x03, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT3._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
            ...
            Device (PRT5)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT5._UPC\n", Zero, Zero, Zero, Zero, Zero, Zero)
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT5._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
    ...
    Scope (_SB.PCI0.GPP2)
    {
        Device (WLAN)
        {
            ...
            Method (MTDS, 0, Serialized)
            {
                ...
                Return (AA91) /* \_SB_.PCI0.GPP2.WLAN.MTDS.AA91 */
            }

            Method (MTGS, 0, Serialized)
            {
                Name (BB91, Package (0x1C)
                {
                    0x4D, 
                    0x54, 
                    0x47, 
                ...
                Return (BB91) /* \_SB_.PCI0.GPP2.WLAN.MTGS.BB91 */
            }

            Method (MTCL, 0, Serialized)
            {
                Name (CC91, Package (0x13)
                {
                    0x4D, 
                    0x54, 
                    0x43, 
                ...
                If ((MNUM == 0x02))
                {
                    Return (CC92) /* \_SB_.PCI0.GPP2.WLAN.MTCL.CC92 */
                }

                Return (CC91) /* \_SB_.PCI0.GPP2.WLAN.MTCL.CC91 */
            }
            ...
            Method (RWRD, 0, Serialized)
            {
                ...
                Return (RWRY) /* \_SB_.PCI0.GPP2.WLAN.RWRD.RWRY */
            }
            ...
            Method (RWSI, 0, Serialized)
            {
                ...
                Return (RWSY) /* \_SB_.PCI0.GPP2.WLAN.RWSI.RWSY */
            }
            ...
            Method (RWGS, 0, Serialized)
            {
                ...
                Return (RWGY) /* \_SB_.PCI0.GPP2.WLAN.RWGS.RWGY */
            }
        }
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (_QD8, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                If ((Local0 <= 0x7D))
                {
                    ^^^^ATKD.STUP (0x08, 0x08, 0x08)
                }
                Else
                {
                    ^^^^ATKD.STUP (0x0C, 0x09, 0x0C)
                    WR_M (0x9098, 0x7D)
                }
            }
    ...
    Scope (WMI0)
    {
        ...
        Method (K0_1, 1, NotSerialized)
        {
            ...
            ElseIf ((FUNC == One))
            {
                TSXR = \_SB.PCI0.SBRG.EC0.RR_M (0x0791)
                TSXL = Zero
            }
            Else
            {
        ...
        Method (K0_2, 2, NotSerialized)
        {
            ...
            If ((DEVS == Zero))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0CBD)
            }
            ElseIf ((DEVS == One))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0CBD)
            ...
            ElseIf ((DEVS == 0x04))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0791)
            }
            ElseIf ((DEVS == 0x05))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9060)
            }
            ElseIf ((DEVS == 0x06))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0790)
            }
            ElseIf ((DEVS == 0x07))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0792)
            }
            ElseIf ((DEVS == 0x08))
            {
            ...
            ElseIf ((DEVS == 0x0A))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x039A)
            }
            ElseIf ((DEVS == 0x0B))
            {
                DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x039B)
            }
            ElseIf ((DEVS == 0x0C))
            {
                Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x9074)
                DEVT = PU_C (Local0)
            }
            ElseIf ((DEVS == 0x0D))
            {
                Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x9070)
                DEVT = PU_C (Local0)
            }
            ElseIf ((DEVS == 0x0E))
            {
                Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x9071)
                DEVT = PU_C (Local0)
            }
            ElseIf ((DEVS == 0x0F))
            {
        ...
        {
            OperationRegion (KX_X, SystemMemory, Arg0, 0x26)
            Field (KX_X, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                SM63,   8, 
            ...
            If ((FUNC == Zero))
            {
                If ((FANX == Zero))
                {
                    ...
                    CURL = \_SB.PCI0.SBRG.EC0.RR_M (0x02A8)
                    CURH = \_SB.PCI0.SBRG.EC0.RR_M (0x02A9)
                }
                ElseIf ((FANX == One))
                {
            ...
            ElseIf ((FUNC == One))
            {
                If ((FANX == Zero))
                {
                    ...
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0621, 0x40)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x02A8, CURL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x02A9, CURH)
                }
                ElseIf ((FANX == One))
                {
    ...
    OperationRegion (EXBU, SystemMemory, 0xB9F5AD98, 0x004B)
    ...
    Scope (_SB.ATKD)
    {
        Method (SRSC, 1, NotSerialized)
        {
            ...
            If ((Arg0 == 0x64))
            {
                ^^PCI0.SBRG.EC0.WR_M (0x07E6, Arg0)
                Local0 = (Arg0 - One)
                ^^PCI0.SBRG.EC0.WR_M (0x07E5, Local0)
                Local0 = ^^PCI0.SBRG.EC0.RR_M (0x07E7)
                Local0 &= 0x3F
                ^^PCI0.SBRG.EC0.WR_M (0x07E7, Local0)
            }
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (FANS, 0, Serialized)
        {
            ...
            {
                /* 0000 */  0x04, 0x9C, 0x64, 0x62, 0x61, 0x63, 0x58, 0x50,  // ..dbacXP
                /* 0008 */  0xFF                                             // .
            })
            Name (AADF, Buffer (0x21)
            {
                /* 0000 */  0x05, 0x46, 0x49, 0x4C, 0x4E, 0x50, 0x55, 0x58,  // .FILNPUX
                /* 0008 */  0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x00, 0x00,  // ZZZZZZ..
                /* 0010 */  0xFF, 0x0A, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,  // ........
                /* 0018 */  0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x00, 0x00,  // ........
                /* 0020 */  0x00                                             // .
            })
            Name (AADH, Buffer (0x21)
            {
                /* 0000 */  0x06, 0x4F, 0x59, 0x64, 0x7C, 0x89, 0x97, 0xA5,  // .OYd|...
                /* 0008 */  0xB5, 0xB5, 0xB5, 0xB5, 0xB5, 0xB5, 0x00, 0x00,  // ........
            ...
            {
                /* 0000 */  0x02, 0x82, 0x03, 0x3D, 0x03, 0x02, 0x03, 0xA1,  // ...=....
                /* 0008 */  0x02, 0x7A, 0x02, 0x57, 0x02, 0x37, 0x02, 0x1B,  // .z.W.7..
                /* 0010 */  0x02, 0x1B, 0x02, 0x1B, 0x02, 0x1B, 0x02, 0x1B,  // ........
                /* 0018 */  0x02, 0x1B, 0x02                                 // ...
            })
            Name (BBDF, Buffer (0x21)
            {
                /* 0000 */  0x08, 0x34, 0x35, 0x36, 0x37, 0x3C, 0x3D, 0x3E,  // .4567<=>
                /* 0008 */  0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x00, 0x00,  // ??????..
                /* 0010 */  0xFF, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,  // ........
                /* 0018 */  0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x00, 0x00,  // ........
                /* 0020 */  0x00                                             // .
            })
            Name (BBDH, Buffer (0x21)
            {
                /* 0000 */  0x09, 0x4F, 0x59, 0x64, 0x7C, 0x89, 0x97, 0xA5,  // .OYd|...
                /* 0008 */  0xB5, 0xB5, 0xB5, 0xB5, 0xB5, 0xB5, 0x00, 0x00,  // ........
                /* 0010 */  0x00, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0018 */  0x03, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0020 */  0x03                                             // .
            })
            Name (F1DG, Buffer (0x1B)
            {
                /* 0000 */  0x03, 0x82, 0x03, 0x3D, 0x03, 0x02, 0x03, 0xA1,  // ...=....
                /* 0008 */  0x02, 0x7A, 0x02, 0x57, 0x02, 0x37, 0x02, 0x1B,  // .z.W.7..
                /* 0010 */  0x02, 0x1B, 0x02, 0x1B, 0x02, 0x1B, 0x02, 0x1B,  // ........
                /* 0018 */  0x02, 0x1B, 0x02                                 // ...
            })
            ...
            ^^PCI0.SBRG.EC0.PTPP (BBDF)
            ^^PCI0.SBRG.EC0.PTPP (BBDH)
            ^^PCI0.SBRG.EC0.PTPP (F1DG)
        }
        ...
        Method (FANP, 0, Serialized)
        {
            ...
            {
                /* 0000 */  0x05, 0x46, 0x49, 0x4C, 0x4E, 0x50, 0x55, 0x58,  // .FILNPUX
                /* 0008 */  0x5A, 0x5B, 0x5C, 0x5C, 0x5C, 0x5C, 0x00, 0x00,  // Z[\\\\..
                /* 0010 */  0xFF, 0x0A, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,  // ........
                /* 0018 */  0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x00, 0x00,  // ........
                /* 0020 */  0x00                                             // .
            })
            ...
            {
                /* 0000 */  0x06, 0x4F, 0x59, 0x64, 0x7C, 0x89, 0x97, 0xA5,  // .OYd|...
                /* 0008 */  0xB5, 0xCE, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00,  // ........
                /* 0010 */  0x00, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0018 */  0x03, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0020 */  0x03                                             // .
            })
            Name (F0DG, Buffer (0x1B)
            {
                /* 0000 */  0x02, 0x82, 0x03, 0x3D, 0x03, 0x02, 0x03, 0xA1,  // ...=....
                /* 0008 */  0x02, 0x7A, 0x02, 0x57, 0x02, 0x37, 0x02, 0x1B,  // .z.W.7..
                /* 0010 */  0x02, 0xDF, 0x01, 0x9E, 0x01, 0x9E, 0x01, 0x9E,  // ........
                /* 0018 */  0x01, 0x9E, 0x01                                 // ...
            })
            Name (BBDF, Buffer (0x21)
            {
                /* 0000 */  0x08, 0x34, 0x35, 0x36, 0x37, 0x3C, 0x3D, 0x3E,  // .4567<=>
                /* 0008 */  0x3F, 0x40, 0x41, 0x41, 0x41, 0x41, 0x00, 0x00,  // ?@AAAA..
                /* 0010 */  0xFF, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,  // ........
                /* 0018 */  0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x00, 0x00,  // ........
                /* 0020 */  0x00                                             // .
            })
        ...
        Method (FANW, 0, Serialized)
        {
            ...
            Name (AADF, Buffer (0x21)
            {
                /* 0000 */  0x05, 0x46, 0x50, 0x50, 0x50, 0x50, 0x50, 0x50,  // .FPPPPPP
                /* 0008 */  0x50, 0x50, 0x50, 0x50, 0x50, 0x50, 0x00, 0x00,  // PPPPPP..
                /* 0010 */  0xFF, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,  // ........
                /* 0018 */  0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x00, 0x00,  // ........
                /* 0020 */  0x00                                             // .
            })
            Name (AADH, Buffer (0x21)
            {
                /* 0000 */  0x06, 0x4F, 0x59, 0x59, 0x59, 0x59, 0x59, 0x59,  // .OYYYYYY
                /* 0008 */  0x59, 0x59, 0x59, 0x59, 0x59, 0x59, 0x00, 0x00,  // YYYYYY..
                /* 0010 */  0x00, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0018 */  0x03, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0020 */  0x03                                             // .
            })
            Name (F0DG, Buffer (0x1B)
            {
                /* 0000 */  0x02, 0x82, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // ...=.=.=
                /* 0008 */  0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // .=.=.=.=
                /* 0010 */  0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // .=.=.=.=
                /* 0018 */  0x03, 0x3D, 0x03                                 // .=.
            })
            Name (BBDF, Buffer (0x21)
            {
                /* 0000 */  0x08, 0x34, 0x37, 0x37, 0x37, 0x37, 0x37, 0x37,  // .4777777
            ...
            Name (BBDH, Buffer (0x21)
            {
                /* 0000 */  0x09, 0x4F, 0x59, 0x59, 0x59, 0x59, 0x59, 0x59,  // .OYYYYYY
                /* 0008 */  0x59, 0x59, 0x59, 0x59, 0x59, 0x59, 0x00, 0x00,  // YYYYYY..
                /* 0010 */  0x00, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0018 */  0x03, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x02,  // ........
                /* 0020 */  0x03                                             // .
            ...
            Name (F1DG, Buffer (0x1B)
            {
                /* 0000 */  0x03, 0x82, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // ...=.=.=
                /* 0008 */  0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // .=.=.=.=
                /* 0010 */  0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D, 0x03, 0x3D,  // .=.=.=.=
                /* 0018 */  0x03, 0x3D, 0x03                                 // .=.
            })
        ...
        Method (FANL, 1, Serialized)
        {
            ...
            {
                FN_M = Zero
                ^^PCI0.SBRG.EC0.WR_M (0x0797, Zero)
            }
            ElseIf ((Local0 == One))
            {
                FN_M = One
                ^^PCI0.SBRG.EC0.WR_M (0x0797, One)
            }
            Else
            {
                FN_M = 0x02
                ^^PCI0.SBRG.EC0.WR_M (0x0797, 0x02)
            }
        ...
        Method (GQFS, 0, NotSerialized)
        {
            Local0 = FN_M /* \FN_M */
            Local0 |= 0x00030000
            ^^PCI0.SBRG.EC0.DOTP (Ones)
            Return (Local0)
        }

        Method (STUP, 3, Serialized)
        {
            Name (UTDP, Buffer (0x08) {})
            CreateWordField (UTDP, Zero, M254)
            CreateByteField (UTDP, 0x02, M255)
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (GLKB, 1, NotSerialized)
        {
            ...
            ElseIf ((Arg0 == 0x02))
            {
                Local0 = ^^PCI0.SBRG.EC0.RR_M (0x9054)
                If ((Local0 == 0x03))
                {
                    Local1 = 0x83
                }
