 ...
 *
 * Disassembly of /tmp/tmp.37XA1EsdZV/VivoBook_ASUSLaptop_X412DA_X412DA_463896c0c0a0/VivoBook_ASUSLaptop_X412DA_X412DA, Thu May 21 15:25:27 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C0E7 (49383)
 *     Revision         0x02
 *     Checksum         0x0E
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x5DA70000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x5DA74000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD110510)
    Name (FTPM, 0xFD110510)
    Name (PPIM, 0x5DCC7F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x5DCB1000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (AWLN, SystemMemory, AWLB, 0x31)
            ...
            Device (PRT6)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT1._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0C
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT1._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT2._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0D
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT2._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT3._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0E
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT3._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT4._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0F
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT4._PLD.PLD1 */
                    }
                }
            }
            ...
            Device (PRT2)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT1._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0C
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT1._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT2._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0D
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT2._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT3._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0E
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT3._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT4._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0F
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT4._PLD.PLD1 */
                    }
                }
            }
    ...
    Scope (_SB.PCI0.GP17.XHC1.RHUB.PRT2.PRT1)
    {
        ...
        Device (DCAM)
        {
            ...
            {
                Return (CAPD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.PRT1.CAPD */
            }
        }
    }

    Scope (_SB.PCI0.GP17.XHC0.RHUB.PRT6.PRT1)
    {
        Name (CAP2, Package (0x01)
        {
            Buffer (0x14)
            {
                /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x14, 0x00, 0x14, 0x00,  // ........
        ...
        Device (CAM2)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (CAP2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.PRT1.CAP2 */
            }
        }
    }
    ...
    Scope (_SB.PCI0.GPP1.DEV0)
    {
        Method (RWRD, 0, Serialized)
        {
            ...
            Return (RWRY) /* \_SB_.PCI0.GPP1.DEV0.RWRD.RWRY */
        }
        ...
        Method (RWSI, 0, Serialized)
        {
            ...
            Return (RWSY) /* \_SB_.PCI0.GPP1.DEV0.RWSI.RWSY */
        }
    }
    ...
    Scope (_SB.PCI0.GPP1.DEV0)
    {
        ...
        Method (EWRD, 0, Serialized)
        {
            ...
            Return (EWRY) /* \_SB_.PCI0.GPP1.DEV0.EWRY */
        }
    }
