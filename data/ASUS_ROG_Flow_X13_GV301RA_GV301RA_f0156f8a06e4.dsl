 ...
 *
 * Disassembly of /tmp/tmp.e5oIvBp5IU/ROG_Flow_X13_GV301RA_GV301RA_f0156f8a06e4/ROG_Flow_X13_GV301RA_GV301RA, Tue Sep 15 09:37:35 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000101C8 (65992)
 *     Revision         0x02
 *     Checksum         0x3A
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB2E24000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB2E28000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB81AEF98)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB81B1D18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xB81B2000, 0x0100)
