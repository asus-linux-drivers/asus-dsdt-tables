 ...
 *
 * Disassembly of /tmp/tmp.e5oIvBp5IU/ZenBook_UX425IA_UM425IA_998fa0fb0a4d_2/ZenBook_UX425IA_UM425IA, Tue Sep 15 09:59:42 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C1BE (49598)
 *     Revision         0x02
 *     Checksum         0xA0
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC34C000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC350000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0xCC575F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    OperationRegion (EXBU, SystemMemory, 0xCC575A18, 0x0049)
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00110019))
                    {
                        ^^PCI0.SBRG.EC0.QFAN = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                        Return (GQFS ())
                    }
