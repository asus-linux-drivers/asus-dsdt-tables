 ...
 *
 * Disassembly of /tmp/tmp.oEwYBAwSlW/Vivobook_ASUSLaptop_M7600QE_M7600QE
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC716000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC71A000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC93B918)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC93BC18, 0x0E)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC93C000, 0x0100)
