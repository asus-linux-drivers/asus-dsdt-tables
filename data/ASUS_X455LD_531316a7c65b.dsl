 ...
 *
 * Disassembly of /tmp/tmp.W11lRqaUXQ/X455LD_531316a7c65b/X455LD, Tue Jun 16 18:57:44 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xAEB15C18, 0x02B2)
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (BSTS, 0, NotSerialized)
            {
                ...
                Local0 |= (IKF2 << 0x08)
                Local1 = ^^PCI0.LPCB.EC0.RRAM (0xF8FE)
                Local2 = Zero
                If ((Local1 == 0x35))
                {
                    Local2 = One
                ...
                Else
                {
                    Local0 = ^^PCI0.LPCB.EC0.RRAM (0xF8FE)
                    If (((Local0 & 0xFF) == 0x34))
                    {
                        Local0 = 0x05
                        Return (Local0)
            ...
            Method (GLKB, 1, NotSerialized)
            {
                If ((Arg0 == One))
                {
                    Local0 = ^^PCI0.LPCB.EC0.RRAM (0xF8B0)
                    Local0 &= 0x80
                    If (Local0)
                    {
                        Return (One)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        {
            Notify (^^^RP05.PEGP, 0xD3) // Hardware-Specific
        }
    ...
    Scope (_SB)
    {
        Device (LID)
        {
            ...
            {
                Local0 = One
                Local0 = ^^PCI0.LPCB.EC0.RPIN (0xB4)
                If ((Local0 == Ones))
                {
                    Local0 = One
                }
    ...
    Scope (\)
    {
        ...
        Method (DCPS, 1, Serialized)
        {
            Local0 = \_SB.PCI0.LPCB.EC0.RPIN (0xB0)
            Local0 ^= One
            Return (Local0)
        }
        ...
        Method (ACPS, 0, Serialized)
        {
            Local0 = \_SB.PCI0.LPCB.EC0.RPIN (0xB1)
            Local0 ^= One
            Return (Local0)
        }
