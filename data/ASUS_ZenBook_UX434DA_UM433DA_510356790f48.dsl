 ...
 *
 * Disassembly of /tmp/tmp.piOeGN5qP1/ZenBook_UX434DA_UM433DA_510356790f48/ZenBook_UX434DA_UM433DA, Tue Jul 14 17:24:47 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000BDC1 (48577)
 *     Revision         0x02
 *     Checksum         0xC5
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x5D495000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x5D499000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD110510)
    Name (FTPM, 0xFD110510)
    Name (PPIM, 0x5D69EF98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x5D688000, 0x0100)
    ...
    Scope (_SB.PCI0.GP17.XHC0.RHUB.PRT6)
    {
        ...
        Device (CAM2)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (CAP2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6.CAP2 */
            }
        }
