 ...
 *
 * Disassembly of /tmp/tmp.27CHi3cjOM/Vivobook_ASUSLaptop_M7600QC_M7600QC_ef36c654c4f5/Vivobook_ASUSLaptop_M7600QC_M7600QC, Tue Jun 30 08:46:36 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C73B (51003)
 *     Revision         0x02
 *     Checksum         0x45
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC72E000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC732000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC94A918)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC94AC18, 0x0E)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC94B000, 0x0100)
        ...
        Device (ATKD)
        {
            ...
            Scope (\_SB.ATKD)
            {
                ...
                Method (DIAL, 1, NotSerialized)
                {
                    ...
                    {
                        DIBF = Arg0
                        Notify (^^I2CA.DIDV, One) // Device Check
                        Return (One)
                    }
                    ElseIf ((Arg0 == Zero))
                    {
    ...
    Scope (_SB.I2CA)
    {
        Device (DIDV)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.I2CA.DIDV._CRS.SBFI */
            }
        }
    }
            ...
            Device (PRT1)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT1._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0D
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT1._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT2._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0E
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT2._PLD.PLD1 */
                    }
                }
            }
