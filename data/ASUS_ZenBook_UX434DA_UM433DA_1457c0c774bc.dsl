 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/ZenBook_UX434DA_UM433DA_1457c0c774bc/ZenBook_UX434DA_UM433DA, Sat Aug 22 21:15:39 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x5D4AD000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x5D4B1000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD110510)
    Name (FTPM, 0xFD110510)
    Name (PPIM, 0x5D6B6F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x5D6A0000, 0x0100)
