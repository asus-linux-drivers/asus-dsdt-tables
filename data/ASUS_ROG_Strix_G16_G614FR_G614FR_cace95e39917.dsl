 ...
 *
 * Disassembly of /tmp/tmp.ny3abPt6uT/ROG_Strix_G16_G614FR_G614FR
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010E16 (69142)
 *     Revision         0x02
 *     Checksum         0xA5
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x71F1BC98, 0x04)
                    ...
                    Scope (PCI0)
                    {
                        Device (S900)
                        {
                            ...
                            Name (CRS, Buffer (0x0166)
                            {
                                ...
                                /* 00F8 */  0x47, 0x01, 0x00, 0x05, 0x00, 0x05, 0x00, 0x80,  // G.......
                                /* 0100 */  0x47, 0x01, 0x80, 0x05, 0x80, 0x05, 0x00, 0x80,  // G.......
                                /* 0108 */  0x47, 0x01, 0x00, 0x07, 0x00, 0x07, 0x00, 0x80,  // G.......
                                /* 0110 */  0x47, 0x01, 0x80, 0x07, 0x80, 0x07, 0x00, 0x80,  // G.......
                                /* 0118 */  0x47, 0x01, 0x00, 0x0A, 0x00, 0x0A, 0x00, 0x80,  // G.......
                                /* 0120 */  0x47, 0x01, 0x80, 0x0A, 0x80, 0x0A, 0x00, 0x80,  // G.......
                                /* 0128 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0xDC, 0xFE,  // ........
                                /* 0130 */  0x00, 0x10, 0x00, 0x00, 0x86, 0x09, 0x00, 0x01,  // ........
                                /* 0138 */  0x00, 0x00, 0xE0, 0xFE, 0x00, 0x10, 0x00, 0x00,  // ........
                                /* 0140 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,  // ........
                                /* 0148 */  0x00, 0x00, 0x00, 0x00, 0x86, 0x09, 0x00, 0x01,  // ........
                                /* 0150 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                /* 0158 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,  // ........
                                /* 0160 */  0x00, 0x00, 0x00, 0x00, 0x79, 0x00               // ....y.
                            })
                            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                            {
                                ...
                                CreateDWordField (CRS, 0x0144, SPIB)
                                CreateDWordField (CRS, 0x0148, SPIL)
                                SPIB = 0xFEC10000
                                SPIL = 0x1000
                                If (WDTB)
                                {
                                    CreateDWordField (CRS, 0x0150, WDTB)
                                    CreateDWordField (CRS, 0x0154, WDTL)
                                    WDTB = \WDTB
                                    WDTL = \WDTL
                                }

                                CreateDWordField (CRS, 0x015C, ROMB)
                                CreateDWordField (CRS, 0x0160, ROML)
                                ROMB = 0xFF000000
                                ROML = 0x01000000
    ...
    Scope (_SB.I2CA)
    {
        Device (TPD0)
        {
            ...
            CreateWordField (RBUF, 0x10, SLAV)
            CreateDWordField (RBUF, 0x0C, SPED)
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
        ...
        Device (SPKR)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, Buffer (0xC6)
                {
                    ...
                    /* 0018 */  0x32, 0x43, 0x44, 0x00, 0x8E, 0x19, 0x00, 0x01,  // 2CD.....
                    /* 0020 */  0x00, 0x01, 0x02, 0x00, 0x00, 0x01, 0x06, 0x00,  // ........
                    /* 0028 */  0x40, 0x42, 0x0F, 0x00, 0x41, 0x00, 0x5C, 0x5F,  // @B..A.\_
                    /* 0030 */  0x53, 0x42, 0x2E, 0x49, 0x32, 0x43, 0x44, 0x00,  // SB.I2CD.
                    /* 0038 */  0x8C, 0x20, 0x00, 0x01, 0x01, 0x01, 0x00, 0x02,  // . ......
                    /* 0040 */  0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x17, 0x00,  // ........
                    /* 0048 */  0x00, 0x19, 0x00, 0x23, 0x00, 0x00, 0x00, 0x09,  // ...#....
                    /* 0050 */  0x00, 0x5C, 0x5F, 0x53, 0x42, 0x2E, 0x47, 0x50,  // .\_SB.GP
                    /* 0058 */  0x49, 0x4F, 0x00, 0x8C, 0x20, 0x00, 0x01, 0x01,  // IO.. ...
                    /* 0060 */  0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00,  // ........
                    /* 0068 */  0x00, 0x17, 0x00, 0x00, 0x19, 0x00, 0x23, 0x00,  // ......#.
                    /* 0070 */  0x00, 0x00, 0x4E, 0x00, 0x5C, 0x5F, 0x53, 0x42,  // ..N.\_SB
                    /* 0078 */  0x2E, 0x47, 0x50, 0x49, 0x4F, 0x00, 0x8C, 0x20,  // .GPIO.. 
                    /* 0080 */  0x00, 0x01, 0x01, 0x01, 0x00, 0x09, 0x00, 0x01,  // ........
                    /* 0088 */  0x00, 0x00, 0x64, 0x00, 0x17, 0x00, 0x00, 0x19,  // ..d.....
                    /* 0090 */  0x00, 0x23, 0x00, 0x00, 0x00, 0x82, 0x00, 0x5C,  // .#.....\
                    /* 0098 */  0x5F, 0x53, 0x42, 0x2E, 0x47, 0x50, 0x49, 0x4F,  // _SB.GPIO
                    /* 00A0 */  0x00, 0x8C, 0x20, 0x00, 0x01, 0x00, 0x01, 0x00,  // .. .....
                    /* 00A8 */  0x0D, 0x00, 0x01, 0x00, 0x00, 0x64, 0x00, 0x17,  // .....d..
                    /* 00B0 */  0x00, 0x00, 0x19, 0x00, 0x23, 0x00, 0x00, 0x00,  // ....#...
                    /* 00B8 */  0x82, 0x00, 0x5C, 0x5F, 0x53, 0x42, 0x2E, 0x47,  // ..\_SB.G
                    /* 00C0 */  0x50, 0x49, 0x4F, 0x00, 0x79, 0x00               // PIO.y.
                })
    ...
    OperationRegion (EXBU, SystemMemory, 0x71F1B698, 0x01DF)
