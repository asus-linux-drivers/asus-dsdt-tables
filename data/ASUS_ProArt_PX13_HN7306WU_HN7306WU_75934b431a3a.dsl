 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/ProArt_PX13_HN7306WU_HN7306WU_75934b431a3a/ProArt_PX13_HN7306WU_HN7306WU, Sat Aug 22 21:09:03 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001332A (78634)
 *     Revision         0x02
 *     Checksum         0xB9
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.GPP9.M236, BuffObj)
    ...
    External (_SB_.PCI0.GPP9.PEGP.DSTA, UnknownObj)
    External (_SB_.PCI0.GPP9.PEGP.EDP1, DeviceObj)
    External (_SB_.PCI0.GPP9.PEGP.INIA, UnknownObj)
    External (_SB_.PCI0.GPP9.PEGP.NLIM, UnknownObj)
    External (_SB_.PCI0.GPP9.PEGP.TGPU, UnknownObj)
    External (_SB_.PCI0.GPP9.SWUS.SWDS.VGA_, DeviceObj)
        ...
        Device (AC0)
        {
            ...
            Method (_PSR, 0, NotSerialized)  // _PSR: Power Source
            {
                ...
                If (((ACPF != ACDC) || (ACDC == 0xFF)))
                {
                    ...
                    SSZE = 0x03
                    CreateWordField (DPTI, Zero, SIZE)
                    CreateByteField (DPTI, 0x02, MSID)
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (AGPL, 1, Serialized)
        {
            ...
            If (((Local1 >= 0xD1) && (Local1 <= 0xD5)))
            {
                If (^^^GPP9.PEGP.INIA)
                {
                    Notify (^^^GPP9.PEGP, Local1)
                }
                Else
                {
                    ^^^GPP9.PEGP.DSTA = Local1
                }
            }
        }
    }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (_QD6, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            ...
            If (((((Local0 == Zero) || (Local0 == One)) || (Local0 == 
                0x04)) || (Local0 == 0x05)))
            {
                DSMA = One
                If ((MDSE >= One))
            ...
            ElseIf (((Local0 == 0x06) || (Local0 == 0x07)))
            {
                DSMA = 0x02
                If ((MDSE >= One))
                {
        ...
        {
            Local1 = ST8E (0x4C, Zero)
            Local1 &= One
            If (((^^^^NPCF.DBDC == Zero) && (Local1 == Zero)))
            {
                ^^^^NPCF.DBDC = One
            }

            If (((^^^^NPCF.DBDC == One) && (Local1 == One)))
            {
                ^^^^NPCF.DBDC = Zero
            }
    ...
    Scope (_SB)
    {
        ...
        {
            CreateByteField (^PCI0.GPP9.M236, One, M243)
            CreateByteField (^PCI0.GPP9.M236, 0x02, M244)
            Local5 = M017 (Zero, M243, M244, 0x19, Zero, 0x08)
            Local0 = M019 (Local5, Zero, Zero, Zero)
            Local1 = Zero
            While ((Local0 == 0xFFFFFFFF))
            {
                Sleep (0x64)
                M018 (Zero, M243, M244, 0x68, 0x04, One, Zero)
                Local0 = M019 (Local5, Zero, Zero, Zero)
                Local1 = (One + Local1)
                If ((Local1 == 0xC8))
                {
        ...
        Device (ATKD)
        {
            ...
            Scope (\_SB.ATKD)
            {
                ...
                Method (DGPS, 2, NotSerialized)
                {
                    ...
                    ^^PCI0.GPP9.PEGP.TGPU = DerefOf (Arg1 [Arg0])
                ...
                Method (DIAL, 1, NotSerialized)
                {
                    ...
                    {
                        DIBF = 0x02
                        Notify (^^I2CC.DIDV, One) // Device Check
                        Return (One)
                    }
                    ElseIf ((Arg0 == Zero))
                    {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00120098))
                    {
                        Local0 = ^^NPCF.ACBT /* External reference */
                        Local0 = (Local0 / 0x08)
                        Local0 |= 0x00010000
                        Return (Local0)
                    }
                    ...
                    If ((IIA0 == 0x0012009A))
                    {
                        Local0 = ^^NPCF.ATPP /* External reference */
                        Local0 = (Local0 / 0x08)
                        Local0 |= 0x00010000
                        Return (Local0)
                    }
    ...
    Scope (_SB.I2CC)
    {
        Device (DIDV)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.I2CC.DIDV._CRS.SBFI */
            }
        }
    }
    ...
    Mutex (BTMT, 0x00)
    If (CondRefOf (\_SB.PCI0.GPPC.XHC0.RHUB.PRT5))
    {
        Scope (_SB.PCI0.GPPC.XHC0.RHUB.PRT5)
        {
    ...
    Scope (_SB.I2CD)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "10431ED3")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
