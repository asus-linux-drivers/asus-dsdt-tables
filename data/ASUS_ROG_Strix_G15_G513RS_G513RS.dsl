 ...
 *
 * Disassembly of ./dsdt.dat, Mon Dec  4 18:06:42 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000E19F (57759)
 *     Revision         0x02
 *     Checksum         0x30
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x93E80000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x93E84000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0x99212F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x99200D18, 0x0E)
    ...
    OperationRegion (EXBU, SystemMemory, 0x99200D98, 0x0055)
    ...
    Scope (_SB.ATKD)
    {
        Method (WMNB, 3, Serialized)
        {
            ...
            {
                ^^PCI0.SBRG.MBDC = IIA0 /* \_SB_.ATKD.WMNB.IIA0 */
                If ((IIA0 == 0x00130031))
                {
                    WNVA = 0x9601
                    WNVB = 0x00130031
            ...
            {
                ^^PCI0.SBRG.MBEB = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                ^^PCI0.SBRG.MBEC = IIA0 /* \_SB_.ATKD.WMNB.IIA0 */
                If ((IIA0 == 0x00050011))
                {
                    If ((Arg0 == 0x02))
                    {
