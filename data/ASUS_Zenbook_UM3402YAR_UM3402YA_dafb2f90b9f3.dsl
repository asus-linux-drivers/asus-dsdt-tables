 ...
 *
 * Disassembly of /tmp/tmp.XHgqSGhPB4/Zenbook_UM3402YAR_UM3402YA_dafb2f90b9f3_2/Zenbook_UM3402YAR_UM3402YA, Tue Jul 28 17:26:23 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011778 (71544)
 *     Revision         0x02
 *     Checksum         0x75
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC2E6B18, 0x10)
    ...
    Scope (_SB.I2CD)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "10431683")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
    ...
    OperationRegion (EXBU, SystemMemory, 0xBC192A98, 0x0253)
