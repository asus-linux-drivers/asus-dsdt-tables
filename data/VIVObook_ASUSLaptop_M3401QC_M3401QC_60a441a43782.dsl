 ...
 *
 * Disassembly of /tmp/tmp.X1IYCTc4T3/Vivobook_ASUSLaptop_M3401QC_M3401QC_60a441a43782_2/Vivobook_ASUSLaptop_M3401QC_M3401QC, Fri May 29 14:34:03 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC70E000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC712000)
    Name (TPCS, 0x4000)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC947C18, 0x0C)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC935000, 0x0100)
