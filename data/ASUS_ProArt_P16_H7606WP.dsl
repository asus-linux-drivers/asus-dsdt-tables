...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.OPMS, IntObj)
    ...
    External (_SB_.PCI0.SBRG.EC0_.TCOT, IntObj)
    External (_SB_.PCI0.SBRG.EC0_.UMAF, IntObj)
    External (_SB_.PCI0.SBRG.EC0_.UMPF, IntObj)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Name (MAL, 0x0000006F80000000)
            Name (MAM, 0x0000007FFFFFFFFF)
            Name (NRSB, 0x6F266000)
    ...
    OperationRegion (EXBU, SystemMemory, 0x6F265E98, 0x005B)
        ...
        Method (WMNB, 3, Serialized)
        {
            ...
            If ((Local0 == 0x53545344))
            {
                ...
                If ((IIA0 == 0x00110031))
                {
                    ...
                    {
                        Acquire (^^PCI0.SBRG.EC0.MUT0, 0x1000)
                        Local0 = ^^PCI0.SBRG.EC0.FNSD /* \_SB_.PCI0.SBRG.EC0_.FNSD */
                        Release (^^PCI0.SBRG.EC0.MUT0)
                        If ((Local0 != Zero))
                        {
                            Divide (Local0, 0x64, Local1, Local0)
                ...
                If ((IIA0 == 0x00090031))
                {
                    Local0 = ^^PCI0.SBRG.EC0.GPUM /* \_SB_.PCI0.SBRG.EC0_.GPUM */
                    Local1 = ^^PCI0.SBRG.EC0.OPMS /* \_SB_.PCI0.SBRG.EC0_.OPMS */
                    Local1 <<= 0x08
                    Local0 |= Local1
                    Local0 |= 0x00010000
                    Return (Local0)
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x00090032))
                {
                    If ((IIA1 == One))
                    {
                        ^^PCI0.SBRG.EC0.UMPF = One
                    }
                    Else
                    {
                        ^^PCI0.SBRG.EC0.UMPF = Zero
                    }
                ...
                If ((IIA0 == 0x00090031))
                {
                    ...
                    Local2 = (Local0 & One)
                    ^^PCI0.SBRG.EC0.GPUM = Local2
                    Local3 = (Local0 & 0xFF00)
                    Local3 >>= 0x08
                    ^^PCI0.SBRG.EC0.OPMS = Local3
                    Return (One)
                }
    ...
    Scope (_SB.I2CC)
    {
        Device (PS8)
        {
            Name (_HID, "PS883508")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS8_._CRS.RBUF */
            }
        ...
        Device (PS9)
        {
            Name (_HID, "PS883509")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS9_._CRS.RBUF */
            }
        ...
        Device (PSA)
        {
            Name (_HID, "PS88350A")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSA_._CRS.RBUF */
            }
        ...
        Device (PSF)
        {
            Name (_HID, "PS88350F")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PSF_._CRS.RBUF */
            }
        ...
        Device (PS11)
        {
            Name (_HID, "PS883511")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                ...
                Return (RBUF) /* \_SB_.I2CC.PS11._CRS.RBUF */
            }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        {
            ^^^GPP9.PEGP.NLIM = One
            ^^^GPP9.PEGP.TGPU = GPSV /* \_SB_.PCI0.SBRG.EC0_.GPSV */
