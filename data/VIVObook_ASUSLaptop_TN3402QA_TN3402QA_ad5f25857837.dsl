 ...
 *
 * Disassembly of /tmp/tmp.XHgqSGhPB4/Vivobook_ASUSLaptop_TN3402QA_TN3402QA_ad5f25857837/Vivobook_ASUSLaptop_TN3402QA_TN3402QA, Tue Jul 28 17:24:06 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DA79 (55929)
 *     Revision         0x02
 *     Checksum         0xC2
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.ATKD.BLED, MethodObj)    // 1 Arguments
    External (_SB_.ATKD.WLED, MethodObj)    // 1 Arguments
    External (_SB_.ATKD.WMXC, MethodObj)    // 1 Arguments
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB7AEA000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB7AEE000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC347C98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC347B18, 0x10)
        ...
        Scope (GPP0)
        {
            ...
            Device (WLAN)
            {
                ...
                Method (WRDD, 0, Serialized)
                {
                    ...
                    Return (WRDX) /* \_SB_.PCI0.GPP0.WLAN.WRDX */
                }
                ...
                Method (WRDS, 0, Serialized)
                {
                    If ((VDID == 0x27238086))
                    {
                        Return (WRDY) /* \_SB_.PCI0.GPP0.WLAN.WRDY */
                    }

                    Return (WRD2) /* \_SB_.PCI0.GPP0.WLAN.WRD2 */
                }
    ...
    OperationRegion (EXBU, SystemMemory, 0xBC1F3A98, 0x0252)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (CPAT, 0, NotSerialized)
            {
                PSTB [Zero] = DerefOf (PWST [((DPTN * 0x05
                    ) + Zero)])
                PSTB [One] = DerefOf (PWST [((DPTN * 0x05
                    ) + One)])
                PSTB [0x02] = DerefOf (PWST [((DPTN * 0x05
                    ) + 0x02)])
                PSTB [0x03] = DerefOf (PWST [((DPTN * 0x05
                    ) + 0x03)])
                PSTB [0x04] = DerefOf (PWST [((DPTN * 0x05
                    ) + 0x04)])
                ...
                SSZE = 0x07
                Local0 = (DerefOf (PSTB [0x03]) * 0x03E8)
                SMUF = 0x0C
                SMUD = Local0
                ^^^^ALIB (0x0C, ATCS)
                Local0 = (DerefOf (PSTB [0x04]) * 0x03E8)
                SMUF = 0x11
                SMUD = Local0
                ^^^^ALIB (0x0C, ATCS)
            }
            ...
            Method (DPTC, 0, Serialized)
            {
                ...
                Switch (ToInteger (DPVS))
                {
                    ...
                    {
                        Local0 = 0x3C
                        If ((0x3C > DerefOf (PSTB [Zero])))
                        {
                            Local0 = DerefOf (PSTB [Zero])
                        }
                        ...
                        ^^^^ALIB (0x0C, ATCS)
                        Local0 = 0x1E
                        If ((0x1E > DerefOf (PSTB [One])))
                        {
                            Local0 = DerefOf (PSTB [One])
                        }
                        ...
                        ^^^^ALIB (0x0C, ATCS)
                        Local0 = 0x0F
                        If ((0x0F > DerefOf (PSTB [0x02])))
                        {
                            Local0 = DerefOf (PSTB [0x02])
                        }
                ...
                Device (BATT)
                {
                    ...
                    Method (_BST, 0, Serialized)  // _BST: Battery Status
                    {
                        ...
                        Switch (B1ST)
                        {
                            Case (Zero)
                            {
                                PKG1 [Zero] = (Zero + ((ECWR & 0x20) >> 
                                    0x03))
                            }
                            Case (One)
                            {
                                PKG1 [Zero] = (0x02 + ((ECWR & 0x20) >> 
                                    0x03))
                            }
                            Case (0x02)
                            {
                                PKG1 [Zero] = (One + ((ECWR & 0x20) >> 
                                    0x03))
                            }
                        ...
                        PKG1 [0x03] = B1VT /* \_SB_.PCI0.SBRG.EC0_.B1VT */
