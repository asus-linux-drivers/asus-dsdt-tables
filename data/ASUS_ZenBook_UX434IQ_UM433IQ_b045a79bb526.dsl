 ...
 *
 * Disassembly of /tmp/tmp.ewjZEPARmK/ZenBook_UX434IQ_UM433IQ_b045a79bb526/ZenBook_UX434IQ_UM433IQ, Mon Jun  8 14:16:12 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xAC6E8000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xAC6EC000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xAC93BF98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xAC905000, 0x0100)
