 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/Vivobook_ASUSLaptop_M1405YA_M1405YA_0d2a36e76cb1/Vivobook_ASUSLaptop_M1405YA_M1405YA, Sat Aug 22 21:11:38 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DA3C (55868)
 *     Revision         0x02
 *     Checksum         0xAF
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC500000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC504000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC724918)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC724C18, 0x10)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC725000, 0x0100)
        ...
        Method (MPLI, 2, Serialized)
        {
            ...
            Switch (ToInteger (Arg0))
            {
                ...
                Case (0x07)
                {
                    ...
                    {
                        DSTF = Zero
                        Local0 = REBC (0x1F, One)
                        Local1 = DerefOf (Local0 [Zero])
                        Local1 *= 0x03E8
                        If (((Local1 < DECI) && (Local1 != Zero)))
                        {
                            DECI = Local1
                        }
                    }
    ...
    Scope (_SB.PCI0.GPP4.WLAN)
    {
        Method (MTDS, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MDSP) /* \_SB_.PCI0.GPP4.WLAN.MTDS.MDSP */
            }
            Else
            {
        ...
        Method (MTGS, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MGSP) /* \_SB_.PCI0.GPP4.WLAN.MTGS.MGSP */
            }
            Else
            {
        ...
        Method (MTCL, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MCL6) /* \_SB_.PCI0.GPP4.WLAN.MTCL.MCL6 */
            }
            Else
            {
                Return (Zero)
        ...
        Method (MTCC, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MCC6) /* \_SB_.PCI0.GPP4.WLAN.MTCC.MCC6 */
            }
            Else
            {
                Return (Zero)
