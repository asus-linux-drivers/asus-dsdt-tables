 ...
 *
 * Disassembly of /tmp/tmp.27CHi3cjOM/Zenbook_UX425QA_UM425QA_916b35c4b93d/Zenbook_UX425QA_UM425QA, Tue Jun 30 08:48:26 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DB43 (56131)
 *     Revision         0x02
 *     Checksum         0xFC
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC0CE000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC0D2000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC34AC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCC34AB18, 0x10)
    ...
    OperationRegion (EXBU, SystemMemory, 0xCC1F2A98, 0x0251)
