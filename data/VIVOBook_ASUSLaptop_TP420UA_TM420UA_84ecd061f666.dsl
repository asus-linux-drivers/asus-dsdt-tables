 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/VivoBook_ASUSLaptop_TP420UA_TM420UA_84ecd061f666/VivoBook_ASUSLaptop_TP420UA_TM420UA, Sat Aug 22 21:12:08 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C6A0 (50848)
 *     Revision         0x02
 *     Checksum         0x88
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCAE6D000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCAE71000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC4FAC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCC4FAB18, 0x0C)
    ...
    Method (SPTS, 1, NotSerialized)
    {
        ...
        \_SB.PCI0.SBRG.EC0.ECD2 (0x72, 0xB2)
        CLPS = One
        SLPS = One
        PEWS = PEWS /* \PEWS */
        If ((Arg0 == 0x03))
    ...
    OperationRegion (EXBU, SystemMemory, 0xCB3A6A98, 0x024E)
    ...
    Scope (_SB)
    {
        ThermalZone (TZ0)
        {
            ...
            Method (_CRT, 0, Serialized)  // _CRT: Critical Temperature
            {
                If (^^PCI0.SBRG.EC0.ECAV)
                {
                    Local0 = ^^PCI0.SBRG.EC0.ECRD (RefOf (^^PCI0.SBRG.EC0.TCRT))
                    If ((Local0 != Zero))
                    {
                        Return ((0x0AAC + (Local0 * 0x0A)))
                    }
