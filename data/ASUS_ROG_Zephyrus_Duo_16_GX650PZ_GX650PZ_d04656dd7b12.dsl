 ...
 *
 * Disassembly of /tmp/tmp.W11lRqaUXQ/ROG_Zephyrus_Duo_16_GX650PZ_GX650PZ_d04656dd7b12_2/ROG_Zephyrus_Duo_16_GX650PZ_GX650PZ, Tue Jun 16 18:55:22 2026
 *
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
        ...
        Device (PCI0)
        {
            ...
            Device (GNBD)
            {
                ...
                Device (BROD)
                {
                    ...
                    Name (UMAB, 0x0000000818000000)
                    Name (UMAM, 0x0000000837FFFFFF)
            ...
            Device (GPP6)
            {
                ...
                Method (_PRT, 0, NotSerialized)  // _PRT: PCI Routing Table
                {
                    If (PICM)
                    {
                        Return (AG0E) /* \_SB_.AG0E */
                    }

                    Return (PG0E) /* \_SB_.PG0E */
                }
    ...
    Scope (_SB)
    {
        ...
        Field (CLKR, DWordAcc, Lock, Preserve)
        {
            CLK0,   2
        }
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00050031))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.REBC (0x19, 0x02)
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00050031))
                    {
                        ...
                        Return (^^PCI0.SBRG.EC0.WEBC (0x1A, 0x02, TMBF))
                        Return (Zero)
                    }
                    ...
                    If ((IIA0 == 0x00100052))
                    {
                        Return (^^PCI0.SBRG.EC0.STBF (IIA1))
                    }
    ...
    Scope (_SB.I2CA)
    {
        Device (ETPD)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.I2CA.ETPD._CRS.SBFI */
            }
        }
    }
    ...
    Scope (_SB.I2CB)
    {
        Device (TPL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.I2CB.TPL0._CRS.SBFI */
            }
        }
    }
    ...
    Scope (_TZ)
    {
        ...
        ThermalZone (THRM)
        {
            ...
            Name (_PSL, Package (0x20)  // _PSL: Passive List
            {
                \_SB.PLTF.C000, 
                \_SB.PLTF.C001, 
                \_SB.PLTF.C002, 
            ...
            Device (PRT2)
            {
                ...
                Device (HBP1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP1._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x06
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP1._PLD.XPLD */
                    }
                }
                ...
                Device (HBP2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP2._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x07
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP2._PLD.XPLD */
                    }
                }
                ...
                Device (HBP3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP3._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x08
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP3._PLD.XPLD */
                    }
                }
                ...
                Device (HBP4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP4._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x09
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT2.HBP4._PLD.XPLD */
                    }
                }
            ...
            Device (PRT4)
            {
                ...
                Device (HBP1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP1._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x06
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP1._PLD.XPLD */
                    }
                }
                ...
                Device (HBP2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP2._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x07
                        CreateField (DerefOf (XPLD [Zero]), 0x60, One, EJEC)
                        EJEC = One
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP2._PLD.XPLD */
                    }
                }
                ...
                Device (HBP3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP3._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x08
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP3._PLD.XPLD */
                    }
                }
                ...
                Device (HBP4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (XUPC) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP4._UPC.XUPC */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (XPLD [Zero]), 0x57, 0x08, GPOS)
                        GPOS = 0x09
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.HBP4._PLD.XPLD */
                    }
                }
            ...
            Device (PRT1)
            {
                ...
                Device (DCAN)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        Return (XPLD) /* \_SB_.PCI0.GP19.XHC2.RHUB.PRT1.DCAN._PLD.XPLD */
                    }
                }
            }
        }
    ...
    Scope (_SB.I2CD)
    {
        Device (ASPK)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CD.ASPK._CRS.RBUF */
            }
    ...
    Mutex (BTMT, 0x00)
    Scope (_SB.PCI0.GP17.XHC1.RHUB.PRT2.HBP4)
    {
        Name (RDLY, 0x69)
