 ...
 *
 * Disassembly of /tmp/tmp.e5oIvBp5IU/Vivobook_14_M1405NAQ_23b9701bf345/Vivobook_14_M1405NAQ, Tue Sep 15 09:40:19 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001A2E6 (107238)
 *     Revision         0x02
 *     Checksum         0x85
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.ATKD.SFDC, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.SRSC, MethodObj)    // 1 Arguments
    External (_SB_.ATKD.SSDC, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.STTP, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.STTS, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.STTW, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.SWDC, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.TPDC, MethodObj)    // 0 Arguments
    External (_SB_.ATKD.U1ML, IntObj)
    External (_SB_.ATKP, IntObj)
    External (_SB_.AWAK, MethodObj)    // 1 Arguments
    External (_SB_.FANS, UnknownObj)
    External (_SB_.GPUE, UnknownObj)
    External (_SB_.GPUO, UnknownObj)
    External (_SB_.MPWR, UnknownObj)
    External (_SB_.PCI0.GP17.VGA_.AFN7, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.GP17.VGA_.M460, MethodObj)    // 7 Arguments
    External (_SB_.PCI0.PS2K, DeviceObj)
    External (_SB_.PCI0.SBRG.EC0_.AP_S, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.SBRG.EC0_.ECAV, IntObj)
    External (_SB_.PCI0.SBRG.EC0_.ECMD, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.ECRD, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.ECWT, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.SBRG.EC0_.PECH, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.PECL, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.PENV, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.PLMX, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.RFOV, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.RR_M, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.SKEY, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.WR_M, MethodObj)    // 2 Arguments
    ...
    External (GPUO, IntObj)
    External (H0_1, MethodObj)    // 0 Arguments
    External (M017, MethodObj)    // 6 Arguments
    External (M019, MethodObj)    // 4 Arguments
    External (MPTS, MethodObj)    // 1 Arguments
    External (MPWR, IntObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB762ED98, 0x11)
    ...
    Scope (_SB.PCI0.GP19.XHC2)
    {
        Method (GPL1, 3, Serialized)
        {
            ...
            Return (PCKG) /* \_SB_.PCI0.GP19.XHC2.GPL1.PCKG */
        }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            Return (TPHA) /* \_SB_.I2CD.TPDD.TPHA */
                        }
                        Default
                        {
                            Return (Zero)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (ETPP, 1, Serialized)
            {
                If ((Acquire (MUEC, 0xFFFF) == Zero))
                {
                    Local0 = Zero
                    While ((DerefOf (DerefOf (Arg0 [Local0]) [Zero]) != 
                        0xFF))
                    {
                        CDT1 = DerefOf (DerefOf (Arg0 [Local0]) [Zero])
                        CDT2 = DerefOf (DerefOf (Arg0 [Local0]) [One])
                        If (((CDT1 <= 0x06) && (CDT1 >= One)))
                        {
                            CDT3 = DerefOf (DerefOf (Arg0 [Local0]) [0x02])
                            CDT4 = DerefOf (DerefOf (Arg0 [Local0]) [0x03])
                            CDT5 = DerefOf (DerefOf (Arg0 [Local0]) [0x04])
                            CDT6 = DerefOf (DerefOf (Arg0 [Local0]) [0x05])
                            CDT7 = DerefOf (DerefOf (Arg0 [Local0]) [0x06])
                            CDT8 = DerefOf (DerefOf (Arg0 [Local0]) [0x07])
                            CDT9 = DerefOf (DerefOf (Arg0 [Local0]) [0x08])
                            CD10 = DerefOf (DerefOf (Arg0 [Local0]) [0x09])
                            CD11 = DerefOf (DerefOf (Arg0 [Local0]) [0x0A])
                            CD12 = DerefOf (DerefOf (Arg0 [Local0]) [0x0B])
                            CD13 = DerefOf (DerefOf (Arg0 [Local0]) [0x0C])
                            CD14 = DerefOf (DerefOf (Arg0 [Local0]) [0x0D])
                            CD15 = DerefOf (DerefOf (Arg0 [Local0]) [0x0E])
                            CD16 = DerefOf (DerefOf (Arg0 [Local0]) [0x0F])
                            CD17 = DerefOf (DerefOf (Arg0 [Local0]) [0x10])
                            CD18 = DerefOf (DerefOf (Arg0 [Local0]) [0x11])
                            CD19 = DerefOf (DerefOf (Arg0 [Local0]) [0x12])
                            CD20 = DerefOf (DerefOf (Arg0 [Local0]) [0x13])
                            CD21 = DerefOf (DerefOf (Arg0 [Local0]) [0x14])
                            CD22 = DerefOf (DerefOf (Arg0 [Local0]) [0x15])
                            CD23 = DerefOf (DerefOf (Arg0 [Local0]) [0x16])
                            CD24 = DerefOf (DerefOf (Arg0 [Local0]) [0x17])
                            CD25 = DerefOf (DerefOf (Arg0 [Local0]) [0x18])
                            CD26 = DerefOf (DerefOf (Arg0 [Local0]) [0x19])
                            CD27 = DerefOf (DerefOf (Arg0 [Local0]) [0x1A])
                            CD28 = DerefOf (DerefOf (Arg0 [Local0]) [0x1B])
                            If (((CDT1 <= 0x06) && (CDT1 >= 0x05)))
                            {
                                CD29 = DerefOf (DerefOf (Arg0 [Local0]) [0x1C])
                                CD30 = DerefOf (DerefOf (Arg0 [Local0]) [0x1D])
                                CD31 = DerefOf (DerefOf (Arg0 [Local0]) [0x1E])
                                CD32 = DerefOf (DerefOf (Arg0 [Local0]) [0x1F])
                                CD33 = DerefOf (DerefOf (Arg0 [Local0]) [0x20])
                                CD34 = DerefOf (DerefOf (Arg0 [Local0]) [0x21])
                                CD35 = DerefOf (DerefOf (Arg0 [Local0]) [0x22])
                                CD36 = DerefOf (DerefOf (Arg0 [Local0]) [0x23])
                                CD37 = DerefOf (DerefOf (Arg0 [Local0]) [0x24])
                                CD38 = DerefOf (DerefOf (Arg0 [Local0]) [0x25])
                                CD39 = DerefOf (DerefOf (Arg0 [Local0]) [0x26])
                                CD40 = DerefOf (DerefOf (Arg0 [Local0]) [0x27])
                                CD41 = DerefOf (DerefOf (Arg0 [Local0]) [0x28])
                                CD42 = DerefOf (DerefOf (Arg0 [Local0]) [0x29])
                                CD43 = DerefOf (DerefOf (Arg0 [Local0]) [0x2A])
                                CD44 = DerefOf (DerefOf (Arg0 [Local0]) [0x2B])
                                CD45 = DerefOf (DerefOf (Arg0 [Local0]) [0x2C])
                                CD46 = DerefOf (DerefOf (Arg0 [Local0]) [0x2D])
                                CD47 = DerefOf (DerefOf (Arg0 [Local0]) [0x2E])
                                CD48 = DerefOf (DerefOf (Arg0 [Local0]) [0x2F])
                                CD49 = DerefOf (DerefOf (Arg0 [Local0]) [0x30])
                                CD50 = DerefOf (DerefOf (Arg0 [Local0]) [0x31])
                                CD51 = DerefOf (DerefOf (Arg0 [Local0]) [0x32])
                                CD52 = DerefOf (DerefOf (Arg0 [Local0]) [0x33])
                                CD53 = DerefOf (DerefOf (Arg0 [Local0]) [0x34])
                                CD54 = DerefOf (DerefOf (Arg0 [Local0]) [0x35])
                                CD55 = DerefOf (DerefOf (Arg0 [Local0]) [0x36])
                                CD56 = DerefOf (DerefOf (Arg0 [Local0]) [0x37])
                            }
                        }
            ...
            Method (UCEV, 0, Serialized)
            {
                ...
                {
                    Local0 = One
                    ^^^^UBTC.CCI0 = RR_M (0x0C44)
                    ^^^^UBTC.CCI1 = RR_M (0x0C45)
                    ^^^^UBTC.CCI2 = RR_M (0x0C46)
                    ^^^^UBTC.CCI3 = RR_M (0x0C47)
                    ^^^^UBTC.MGI0 = RR_M (0x0C50)
                    ^^^^UBTC.MGI1 = RR_M (0x0C51)
                    ^^^^UBTC.MGI2 = RR_M (0x0C52)
                    ^^^^UBTC.MGI3 = RR_M (0x0C53)
                    ^^^^UBTC.MGI4 = RR_M (0x0C54)
                    ^^^^UBTC.MGI5 = RR_M (0x0C55)
                    ^^^^UBTC.MGI6 = RR_M (0x0C56)
                    ^^^^UBTC.MGI7 = RR_M (0x0C57)
                    ^^^^UBTC.MGI8 = RR_M (0x0C58)
                    ^^^^UBTC.MGI9 = RR_M (0x0C59)
                    ^^^^UBTC.MGIA = RR_M (0x0C5A)
                    ^^^^UBTC.MGIB = RR_M (0x0C5B)
                    ^^^^UBTC.MGIC = RR_M (0x0C5C)
                    ^^^^UBTC.MGID = RR_M (0x0C5D)
                    ^^^^UBTC.MGIE = RR_M (0x0C5E)
                    ^^^^UBTC.MGIF = RR_M (0x0C5F)
                }
                Else
                {
                    Local0 = Ones
            ...
            Method (_QDE, 0, Serialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                M254 = 0x07
                Local0 = (RR_M (0x9090) & One)
                Local1 = (RR_M (0x9090) & 0x02)
                Local4 = (RR_M (0x9090) & 0x10)
                Local5 = (RR_M (0x9090) & 0x20)
                Switch (FN_M)
                {
                    Case (One)
                    {
                        ...
                        {
                            M255 = 0x07
                            M256 = (0x61A8 - (RR_M (0x9093) * 0x03E8))
                            ALIB (0x0C, UTDP)
                            If (((0x61A8 - (RR_M (0x9093) * 0x03E8)) >= 0x61A8))
                            {
                                M255 = 0x07
                                M256 = 0x61A8
                                ALIB (0x0C, UTDP)
                            }
                            ElseIf (((0x61A8 - (RR_M (0x9093) * 0x03E8)) <= 
                                0x1F40))
                            {
                                M255 = 0x07
                                M256 = 0x1F40
                        ...
                        ElseIf ((Local0 | Local4))
                        {
                            M255 = 0x2E
                            M256 = (0x2710 - (RR_M (0x9092) * 0x03E8))
                            ALIB (0x0C, UTDP)
                            If (((0x2710 - (RR_M (0x9092) * 0x03E8)) >= 0x2710))
                            {
                                M255 = 0x2E
                                M256 = 0x2710
                                ALIB (0x0C, UTDP)
                            }
                            ElseIf (((0x2710 - (RR_M (0x9092) * 0x03E8)) <= 
                                0x1F40))
                            {
                                M255 = 0x2E
                                M256 = 0x1F40
                    ...
                    Case (0x02)
                    {
                        ...
                        {
                            M255 = 0x2E
                            M256 = (0x4650 - (RR_M (0x9092) * 0x03E8))
                            ALIB (0x0C, UTDP)
                            If (((0x4650 - (RR_M (0x9092) * 0x03E8)) >= 0x4650))
                            {
                                M255 = 0x2E
                                M256 = 0x4650
                                ALIB (0x0C, UTDP)
                            }
                            ElseIf (((0x4650 - (RR_M (0x9092) * 0x03E8)) <= 
                                0x32C8))
                            {
                                M255 = 0x2E
                                M256 = 0x32C8
                    ...
                    Default
                    {
                        ...
                        {
                            M255 = 0x2E
                            M256 = (0x3A98 - (RR_M (0x9092) * 0x03E8))
                            ALIB (0x0C, UTDP)
                            If (((0x3A98 - (RR_M (0x9092) * 0x03E8)) >= 0x3A98))
                            {
                                M255 = 0x2E
                                M256 = 0x3A98
                                ALIB (0x0C, UTDP)
                            }
                            ElseIf (((0x3A98 - (RR_M (0x9092) * 0x03E8)) <= 
                                0x32C8))
                            {
                                M255 = 0x2E
                                M256 = 0x32C8
    ...
    Scope (_SB.PCI0)
    {
        Device (BAT0)
        {
            ...
            Method (_BTP, 1, NotSerialized)  // _BTP: Battery Trip Point
            {
                ...
                Local1 = (Arg0 >> 0x08)
                Local2 = (Local1 & 0xFF)
                ^^SBRG.EC0.EX_T (0xA5, Local0, Local2, Zero, Zero, Zero)
                Return (Zero)
            }
        }
    }
    ...
    Scope (WMI0)
    {
        ...
        Method (M632, 2, Serialized)
        {
            ...
            Switch (ToInteger (DEVS))
            {
                Case (Zero)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0508)
                }
                Case (One)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x03E2)
                }
                Case (0x02)
                {
                    WSMI (Arg1)
                ...
                Case (0x03)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x03E0)
                }
                Case (0x04)
                {
                    DEVT = Zero
                ...
                Case (0x0A)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0281)
                }
                Case (0x0B)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0280)
                }
                Case (0x0C)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0570)
                }
                Case (0x0D)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0588)
                }
                Case (0x0E)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0554)
                }
                Case (0x0F)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0555)
                }
                Case (0x10)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0556)
                }
                Case (0x11)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0557)
                }
                Case (0x12)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0560)
                }
                Case (0x13)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0561)
                }
                Case (0x14)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0562)
                }
                Case (0x15)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x0563)
                }
                Case (0x16)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9070)
                }
                Case (0x17)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9071)
                }
                Case (0x18)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9072)
                }
                Case (0x19)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9073)
                }
                Case (0x1A)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9074)
                }
                Case (0x1B)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9075)
                }
                Case (0x1C)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9076)
                }
                Case (0x1D)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9077)
                }
                Case (0x1E)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9078)
                }
                Case (0x1F)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x9079)
                }
                Case (0x20)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x907A)
                }
                Case (0x21)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x907B)
                }
                Case (0x22)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x907C)
                }
                Case (0x23)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x908D)
                }
                Case (0x24)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x908E)
                }
                Case (0x28)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x03E2)
                ...
                Case (0x2A)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x050C)
                }
                Case (0x32)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x05B0)
                }
                Case (0x33)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x05B1)
                }
                Case (0x34)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x05B2)
                }
                Case (0x35)
                {
                    DEVT = \_SB.PCI0.SBRG.EC0.RR_M (0x05B3)
                }
                Case (0x3A)
                {
                    Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x039C)
                    Local1 = \_SB.PCI0.SBRG.EC0.RR_M (0x039D)
                    Local1 <<= 0x08
                    DEVT = (Local1 | Local0)
                }
                Default
        ...
        Method (M633, 1, NotSerialized)
        {
            ...
            If ((FANX == Zero))
            {
                FANS = \_SB.PCI0.SBRG.EC0.RR_M (0x03EC)
                FANT = \_SB.PCI0.SBRG.EC0.F0TS
                TRGG = \_SB.PCI0.SBRG.EC0.RR_M (0x0576)
            }
            ElseIf ((FANX == One))
            {
                FANS = \_SB.PCI0.SBRG.EC0.RR_M (0x03ED)
        ...
        Method (M634, 1, Serialized)
        {
            ...
            If ((FUNC == Zero))
            {
                Switch (ToInteger (PARA))
                {
                    ...
                    Case (0x06)
                    {
                        DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0538)
                    }
                    Case (0x07)
                    {
                        DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0525)
                    }
                    Case (0x08)
                    {
                        DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0526)
                    }
                    Case (0x09)
                    {
                        DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0621)
                    }
                    Default
                    {
                        EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                Switch (ToInteger (PARA))
                {
                    ...
                    Case (0x06)
                    {
                        \_SB.PCI0.SBRG.EC0.WR_M (0x0538, DATA)
                    }
                    Case (0x07)
                    {
                        \_SB.PCI0.SBRG.EC0.WR_M (0x0525, DATA)
                    }
                    Case (0x08)
                    {
                        \_SB.PCI0.SBRG.EC0.WR_M (0x0526, DATA)
                    }
                    Case (0x09)
                    {
                        \_SB.PCI0.SBRG.EC0.WR_M (0x0621, DATA)
                    }
                    Default
                    {
                        EM63 = One
        ...
        Method (M635, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                ...
                OSSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0531)
                OSPV = \_SB.PCI0.SBRG.EC0.RR_M (0x0532)
                THON = \_SB.PCI0.SBRG.EC0.RR_M (0x0533)
                THOF = \_SB.PCI0.SBRG.EC0.RR_M (0x0534)
                FNER = \_SB.PCI0.SBRG.EC0.RR_M (0x0536)
                VGSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0535)
                VGFE = \_SB.PCI0.SBRG.EC0.RR_M (0x0537)
                BCCL = \_SB.PCI0.SBRG.EC0.RR_M (0x079A)
                BCCH = \_SB.PCI0.SBRG.EC0.RR_M (0x079B)
            }
            ElseIf ((FUNC == One))
            {
                \_SB.PCI0.SBRG.EC0.WR_M (0x0530, ECSD)
                \_SB.PCI0.SBRG.EC0.WR_M (0x0531, OSSD)
                \_SB.PCI0.SBRG.EC0.WR_M (0x0532, OSPV)
                ...
                \_SB.PCI0.SBRG.EC0.WR_M (0x0536, FNER)
                \_SB.PCI0.SBRG.EC0.WR_M (0x0535, VGSD)
                \_SB.PCI0.SBRG.EC0.WR_M (0x0537, VGFE)
                \_SB.PCI0.SBRG.EC0.WR_M (0x079A, BCCL)
                \_SB.PCI0.SBRG.EC0.WR_M (0x079B, BCCH)
            }
            Else
            {
                EM63 = One
        ...
        Method (M636, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                If ((ALGM == Zero))
                {
                    TTS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A00)
                    TTS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A01)
                    TTS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A02)
                    TTS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A03)
                    TTS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A04)
                    TTS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A05)
                    TTS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A06)
                    TTS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A07)
                    TTS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A08)
                    TTSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A09)
                    TTSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A0A)
                    TTSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A0B)
                    TTSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A0C)
                    TFFP = 0xFF
                }
                ElseIf ((ALGM == One))
                {
                    TTS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A20)
                    TTS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A21)
                    TTS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A22)
                    TTS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A23)
                    TTS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A24)
                    TTS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A25)
                    TTS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A26)
                    TTS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A27)
                    TTS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A28)
                    TTSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A29)
                    TTSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A2A)
                    TTSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A2B)
                    TTSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A2C)
                    TFFP = 0xFF
                }
                ElseIf ((ALGM == 0x02))
                {
                    TTS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A40)
                    TTS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A41)
                    TTS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A42)
                    TTS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A43)
                    TTS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A44)
                    TTS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A45)
                    TTS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A46)
                    TTS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A47)
                    TTS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A48)
                    TTSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A49)
                    TTSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A4A)
                    TTSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A4B)
                    TTSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A4C)
                    TFFP = 0xFF
                }
                ElseIf ((ALGM == 0x03))
                {
                    TTS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A60)
                    TTS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A61)
                    TTS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A62)
                    TTS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A63)
                    TTS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A64)
                    TTS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A65)
                    TTS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A66)
                    TTS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A67)
                    TTS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A68)
                    TTSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A69)
                    TTSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A6A)
                    TTSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A6B)
                    TTSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A6C)
                    TFFP = 0xFF
                }
                Else
                {
            ...
            ElseIf ((FUNC == One))
            {
                If ((ALGM == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A00, TTS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A01, TTS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A02, TTS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A03, TTS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A04, TTS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A05, TTS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A06, TTS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A07, TTS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A08, TTS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A09, TTSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A0A, TTSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A0B, TTSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A0C, TTSD)
                }
                ElseIf ((ALGM == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A20, TTS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A21, TTS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A22, TTS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A23, TTS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A24, TTS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A25, TTS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A26, TTS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A27, TTS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A28, TTS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A29, TTSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A2A, TTSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A2B, TTSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A2C, TTSD)
                }
                ElseIf ((ALGM == 0x02))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A40, TTS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A41, TTS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A42, TTS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A43, TTS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A44, TTS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A45, TTS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A46, TTS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A47, TTS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A48, TTS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A49, TTSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A4A, TTSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A4B, TTSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A4C, TTSD)
                }
                ElseIf ((ALGM == 0x03))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A60, TTS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A61, TTS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A62, TTS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A63, TTS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A64, TTS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A65, TTS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A66, TTS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A67, TTS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A68, TTS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A69, TTSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A6A, TTSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A6B, TTSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A6C, TTSD)
                }
                Else
                {
                    EM63 = One
        ...
        Method (M637, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                If ((ALGM == Zero))
                {
                    TDA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A80)
                    TDA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A81)
                    TDA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A82)
                    TDA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A83)
                    TDA5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A84)
                    TDA6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A85)
                    TDA7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A86)
                    TDA8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A87)
                    TDA9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A88)
                    TDAA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A89)
                    TDAB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A8A)
                    TDAC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A8B)
                    TDAD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A8C)
                }
                ElseIf ((ALGM == One))
                {
                    TDA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A80)
                ...
                ElseIf ((ALGM == 0x03))
                {
                    TDA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA0)
                    TDA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA1)
                    TDA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA2)
                    TDA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA3)
                    TDA5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA4)
                    TDA6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA5)
                    TDA7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA6)
                    TDA8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA7)
                    TDA9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA8)
                    TDAA = \_SB.PCI0.SBRG.EC0.RR_M (0x0AA9)
                    TDAB = \_SB.PCI0.SBRG.EC0.RR_M (0x0AAA)
                    TDAC = \_SB.PCI0.SBRG.EC0.RR_M (0x0AAB)
                    TDAD = \_SB.PCI0.SBRG.EC0.RR_M (0x0AAC)
                }
                Else
                {
                    EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                If ((ALGM == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A80, TDA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A81, TDA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A82, TDA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A83, TDA4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A84, TDA5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A85, TDA6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A86, TDA7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A87, TDA8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A88, TDA9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A89, TDAA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A8A, TDAB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A8B, TDAC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A8C, TDAD)
                }
                ElseIf ((ALGM == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A80, TDA1)
                ...
                ElseIf ((ALGM == 0x03))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA0, TDA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA1, TDA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA2, TDA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA3, TDA4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA4, TDA5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA5, TDA6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA6, TDA7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA7, TDA8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA8, TDA9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AA9, TDAA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AAA, TDAB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AAB, TDAC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AAC, TDAD)
                }
                Else
                {
                    EM63 = One
        ...
        Method (M638, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                If ((ALGM == Zero))
                {
                    ASC1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A90)
                    ASC2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A91)
                    ASC3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A92)
                    ASC4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A93)
                    ADA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A94)
                    ADA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A95)
                    ADA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A96)
                    ADA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A97)
                    DSC1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A98)
                    DSC2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A99)
                    DSC3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9A)
                    DSC4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9B)
                    DDA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9C)
                    DDA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9D)
                    DDA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9E)
                    DDA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A9F)
                }
                ElseIf ((ALGM == One))
                {
                    ASC1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A90)
                ...
                ElseIf ((ALGM == 0x03))
                {
                    ASC1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB0)
                    ASC2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB1)
                    ASC3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB2)
                    ASC4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB3)
                    ADA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB4)
                    ADA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB5)
                    ADA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB6)
                    ADA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB7)
                    DSC1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB8)
                    DSC2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0AB9)
                    DSC3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABA)
                    DSC4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABB)
                    DDA1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABC)
                    DDA2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABD)
                    DDA3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABE)
                    DDA4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0ABF)
                }
                Else
                {
                    EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                If ((ALGM == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A90, ASC1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A91, ASC2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A92, ASC3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A93, ASC4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A94, ADA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A95, ADA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A96, ADA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A97, ADA4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A98, DSC1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A99, DSC2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9A, DSC3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9B, DSC4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9C, DDA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9D, DDA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9E, DDA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A9F, DDA4)
                }
                ElseIf ((ALGM == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A90, ASC1)
                ...
                ElseIf ((ALGM == 0x03))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB0, ASC1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB1, ASC2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB2, ASC3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB3, ASC4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB4, ADA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB5, ADA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB6, ADA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB7, ADA4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB8, DSC1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AB9, DSC2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABA, DSC3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABB, DSC4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABC, DDA1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABD, DDA2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABE, DDA3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ABF, DDA4)
                }
                Else
                {
                    EM63 = One
        ...
        Method (M639, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                If ((ALGM == Zero))
                {
                    HYS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A10)
                    HYS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A11)
                    HYS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A12)
                    HYS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A13)
                    HYS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A14)
                    HYS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A15)
                    HYS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A16)
                    HYS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A17)
                    HYS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A18)
                    HYSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A19)
                    HYSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A1A)
                    HYSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A1B)
                    HYSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A1C)
                }
                ElseIf ((ALGM == One))
                {
                    HYS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A30)
                    HYS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A31)
                    HYS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A32)
                    HYS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A33)
                    HYS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A34)
                    HYS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A35)
                    HYS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A36)
                    HYS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A37)
                    HYS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A38)
                    HYSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A39)
                    HYSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A3A)
                    HYSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A3B)
                    HYSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A3C)
                }
                ElseIf ((ALGM == 0x02))
                {
                    HYS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A50)
                    HYS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A51)
                    HYS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A52)
                    HYS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A53)
                    HYS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A54)
                    HYS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A55)
                    HYS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A56)
                    HYS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A57)
                    HYS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A58)
                    HYSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A59)
                    HYSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A5A)
                    HYSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A5B)
                    HYSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A5C)
                }
                ElseIf ((ALGM == 0x03))
                {
                    HYS1 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A70)
                    HYS2 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A71)
                    HYS3 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A72)
                    HYS4 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A73)
                    HYS5 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A74)
                    HYS6 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A75)
                    HYS7 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A76)
                    HYS8 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A77)
                    HYS9 = \_SB.PCI0.SBRG.EC0.RR_M (0x0A78)
                    HYSA = \_SB.PCI0.SBRG.EC0.RR_M (0x0A79)
                    HYSB = \_SB.PCI0.SBRG.EC0.RR_M (0x0A7A)
                    HYSC = \_SB.PCI0.SBRG.EC0.RR_M (0x0A7B)
                    HYSD = \_SB.PCI0.SBRG.EC0.RR_M (0x0A7C)
                }
                Else
                {
                    EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                If ((ALGM == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A10, HYS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A11, HYS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A12, HYS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A13, HYS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A14, HYS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A15, HYS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A16, HYS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A17, HYS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A18, HYS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A19, HYSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A1A, HYSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A1B, HYSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A1C, HYSD)
                }
                ElseIf ((ALGM == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A30, HYS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A31, HYS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A32, HYS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A33, HYS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A34, HYS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A35, HYS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A36, HYS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A37, HYS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A38, HYS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A39, HYSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A3A, HYSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A3B, HYSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A3C, HYSD)
                }
                ElseIf ((ALGM == 0x02))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A50, HYS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A51, HYS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A52, HYS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A53, HYS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A54, HYS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A55, HYS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A56, HYS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A57, HYS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A58, HYS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A59, HYSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A5A, HYSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A5B, HYSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A5C, HYSD)
                }
                ElseIf ((ALGM == 0x03))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A70, HYS1)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A71, HYS2)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A72, HYS3)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A73, HYS4)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A74, HYS5)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A75, HYS6)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A76, HYS7)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A77, HYS8)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A78, HYS9)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A79, HYSA)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A7A, HYSB)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A7B, HYSC)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0A7C, HYSD)
                }
                Else
                {
                    EM63 = One
        ...
        {
            OperationRegion (FM63, SystemMemory, Arg0, 0x24)
            Field (FM63, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                SM63,   8, 
            ...
            If ((FUNC == Zero))
            {
                If ((FANX == Zero))
                {
                    TA1L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC0)
                    TA1H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC1)
                    TA2L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC2)
                    TA2H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC3)
                    TA3L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC4)
                    TA3H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC5)
                    TA4L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC6)
                    TA4H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC7)
                    TA5L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC8)
                    TA5H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AC9)
                    TA6L = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACA)
                    TA6H = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACB)
                    TA7L = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACC)
                    TA7H = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACD)
                    TA8L = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACE)
                    TA8H = \_SB.PCI0.SBRG.EC0.RR_M (0x0ACF)
                    TA9L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD0)
                    TA9H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD1)
                    TAAL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD2)
                    TAAH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD3)
                    TABL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD4)
                    TABH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD5)
                    TACL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD6)
                    TACH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD7)
                    TADL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD8)
                    TADH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AD9)
                }
                ElseIf ((FANX == One))
                {
                    TA1L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE0)
                    TA1H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE1)
                    TA2L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE2)
                    TA2H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE3)
                    TA3L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE4)
                    TA3H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE5)
                    TA4L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE6)
                    TA4H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE7)
                    TA5L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE8)
                    TA5H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AE9)
                    TA6L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AEA)
                    TA6H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AEB)
                    TA7L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AEC)
                    TA7H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AED)
                    TA8L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AEE)
                    TA8H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AEF)
                    TA9L = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF0)
                    TA9H = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF1)
                    TAAL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF2)
                    TAAH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF3)
                    TABL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF4)
                    TABH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF5)
                    TACL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF6)
                    TACH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF7)
                    TADL = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF8)
                    TADH = \_SB.PCI0.SBRG.EC0.RR_M (0x0AF9)
                }
                Else
                {
                    EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                If ((FANX == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC0, TA1L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC1, TA1H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC2, TA2L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC3, TA2H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC4, TA3L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC5, TA3H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC6, TA4L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC7, TA4H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC8, TA5L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AC9, TA5H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACA, TA6L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACB, TA6H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACC, TA7L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACD, TA7H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACE, TA8L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0ACF, TA8H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD0, TA9L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD1, TA9H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD2, TAAL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD3, TAAH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD4, TABL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD5, TABH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD6, TACL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD7, TACH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD8, TADL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AD9, TADH)
                }
                ElseIf ((FANX == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE0, TA1L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE1, TA1H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE2, TA2L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE3, TA2H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE4, TA3L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE5, TA3H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE6, TA4L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE7, TA4H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE8, TA5L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AE9, TA5H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AEA, TA6L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AEB, TA6H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AEC, TA7L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AED, TA7H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AEE, TA8L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AEF, TA8H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF0, TA9L)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF1, TA9H)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF2, TAAL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF3, TAAH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF4, TABL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF5, TABH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF6, TACL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF7, TACH)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF8, TADL)
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0AF9, TADH)
                }
                Else
                {
                    EM63 = One
        ...
        Method (M63B, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                If ((PARA == Zero))
                {
                    DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0531)
                }
                ElseIf ((PARA == One))
                {
                    DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0530)
                }
                Else
                {
                    EM63 = One
            ...
            ElseIf ((FUNC == One))
            {
                If ((PARA == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0531, DATA)
                }
                ElseIf ((PARA == One))
                {
                    \_SB.PCI0.SBRG.EC0.WR_M (0x0530, DATA)
                }
                Else
                {
                    EM63 = One
        ...
        Method (M63C, 1, NotSerialized)
        {
            ...
            If ((FUNC == Zero))
            {
                DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x053A)
            }
            ElseIf ((FUNC == One))
            {
                DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x053B)
            }
            ElseIf ((FUNC == 0x02))
            {
                DATA = \_SB.PCI0.SBRG.EC0.RR_M (0x0539)
            }
            ElseIf ((FUNC == 0x03))
            {
    ...
    Scope (_SB)
    {
        Device (LID)
        {
            ...
            {
                Local0 = One
                Local0 = ^^PCI0.SBRG.EC0.RP_N (One, One)
                If ((Local0 == Ones))
                {
                    Local0 = One
                }
                ...
                Local1 = ^^PCI0.SBRG.EC0.RR_M (0x0843)
                If (((Local1 & 0x40) == 0x40))
                {
                    Local1 |= 0x08
                    ^^PCI0.SBRG.EC0.WR_M (0x0843, Local1)
                }
    ...
    Scope (_TZ)
    {
        ...
        ThermalZone (THM2)
        {
            ...
            {
                Local0 = \_SB.PCI0.SBRG.EC0.RC_R ()
                Local1 = \_SB.PCI0.SBRG.EC0.RR_M (0x084B)
                If (((Local1 & One) == One))
                {
                    Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x054C)
                }
            ...
            {
                Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x050C)
                Return (CT_K (Local0))
            }
        }
        ...
        Device (FAN0)
        {
            ...
            {
                Local0 = (\_SB.PCI0.SBRG.EC0.RFOV (Zero) * 0x64)
                Local0 >>= 0x08
                TFST [One] = Local0
                Local1 = \_SB.PCI0.SBRG.EC0.RR_M (0x903C)
                Local2 = \_SB.PCI0.SBRG.EC0.RR_M (0x903D)
                Local0 = (Local2 << 0x08)
                Local0 |= Local1
                TFST [0x02] = Local0
                Return (TFST) /* \_TZ_.FAN0.TFST */
            }
                ...
                If ((Arg0 == ToUUID ("a7611840-99fe-41ae-a488-35c75926c8eb") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x02)
                        {
                            ...
                            Local1 = (Local0 & 0xFF)
                            \_SB.PCI0.SBRG.EC0.WR_M (0x90A0, Local1)
                            Local1 = (Local0 >> 0x08)
                            \_SB.PCI0.SBRG.EC0.WR_M (0x90A1, Local1)
                            Local0 = DerefOf (Arg3 [One])
                            Local1 = (Local0 & 0xFF)
                            \_SB.PCI0.SBRG.EC0.WR_M (0x90A2, Local1)
                            Local1 = (Local0 >> 0x08)
                            \_SB.PCI0.SBRG.EC0.WR_M (0x90A3, Local1)
                            Local0 = \_SB.PCI0.SBRG.EC0.RR_M (0x90A8)
                            Local1 = (Local0 & 0xFC)
                            \_SB.PCI0.SBRG.EC0.WR_M (0x90A8, Local1)
                            Return (Zero)
                        }
                        Case (0x03)
                        {
        ...
        Method (FNCL, 0, NotSerialized)
        {
            ...
            If (ECON)
            {
                If ((\_SB.PCI0.SBRG.EC0.ECAV () && ETMD))
                {
                    If (((Local0 != Zero) && (Local1 != Zero)))
                    {
                        \_SB.PCI0.SBRG.EC0.ECWT (AC0F, RefOf (\_SB.PCI0.SBRG.EC0.PENV))
                    }
                    ElseIf (((Local0 == Zero) && (Local1 != Zero)))
                    {
                        \_SB.PCI0.SBRG.EC0.ECWT (AC1F, RefOf (\_SB.PCI0.SBRG.EC0.PENV))
                    }
                    Else
                    {
                        \_SB.PCI0.SBRG.EC0.ECWT (Zero, RefOf (\_SB.PCI0.SBRG.EC0.PENV))
                    }

                    \_SB.PCI0.SBRG.EC0.ECMD (0x1A)
                }
            }
        }
        ...
        ThermalZone (TZ00)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                If (ECON)
                {
                    Local0 = \_SB.PCI0.SBRG.EC0.ECRD (RefOf (\_SB.PCI0.SBRG.EC0.PLMX))
    ...
    OperationRegion (EXBU, SystemMemory, 0xB7640F18, 0x004B)
    ...
    Scope (_SB.ATKD)
    {
        Method (WMNB, 3, Serialized)
        {
            ...
            If ((Local0 == 0x53545344))
            {
                ...
                {
                    Local0 = 0x00010000
                    If ((((COPK == Zero) || (COPK == One)) || (COPK == 0xFF)))
                    {
                        Local0 |= 0x40
                        Local0 |= One
                    }
                    ElseIf (((COPK == 0x02) || (COPK == 0x80)))
                    {
                        Local0 |= 0x04
                    }
                    Else
                ...
                If ((IIA0 == 0x00110013))
                {
                    Local0 = Zero
                    Local0 |= 0x00010000
                    Local1 = ^^PCI0.SBRG.EC0.F0TS /* \_SB_.PCI0.SBRG.EC0_.F0TS */
                    If ((Local1 == Zero))
                    {
                        Local0 += Local1
                    }
                    Else
                    {
                        Divide (0x008C6180, 0x80, Local3, Local2)
                        Local2 *= 0x3C
                        Local1 *= 0x02
                        Divide (Local2, Local1, Local3, Local4)
                        Divide (Local4, 0x64, Local3, Local5)
                        Local0 += Local5
                    }
                ...
                If ((IIA0 == 0x00110014))
                {
                    Local0 = Zero
                    Local0 |= 0x00010000
                    Local1 = ^^PCI0.SBRG.EC0.F1TS /* \_SB_.PCI0.SBRG.EC0_.F1TS */
                    If ((Local1 == Zero))
                    {
                        Local0 += Local1
                    }
                ...
                {
                    Local0 = 0x00010000
                    Local1 = GPUO /* External reference */
                    Local0 |= Local1
                    Local1 = MPWR /* External reference */
                    Local1 <<= 0x08
                    Local0 |= Local1
                    Return (Local0)
                }
                ...
                {
                    Local0 = 0x00010000
                    Local1 = ^^PCI0.SBRG.EC0.RR_M (0x0C2A)
                    Local2 = ^^PCI0.SBRG.EC0.RR_M (0x0C28)
                    If ((Local1 & One))
                    {
                        If ((Local2 < 0x3A))
                        {
                ...
                {
                    Local0 = 0x00010000
                    Local1 = ^^PCI0.SBRG.EC0.RR_M (0x908C)
                    If ((Local1 & 0xA0))
                    {
                        Local0 |= One
                    }
                ...
                If ((IIA0 == 0x0012007E))
                {
                    Local0 = ^^PCI0.SBRG.EC0.RR_M (0x0843)
                    Local0 &= 0x80
                    If ((Local0 == Zero))
                    {
                        Return (0x00010000)
                ...
                If ((IIA0 == 0x0012007F))
                {
                    Local0 = ^^PCI0.SBRG.EC0.RR_M (0x0846)
                    Local1 = ^^PCI0.SBRG.EC0.RR_M (0x0847)
                    Local1 <<= 0x08
                    Local0 += Local1
                    Local0 = (Local0 / 0x3C)
                    Local0 += 0x00010000
                ...
                If ((IIA0 == 0x00120057))
                {
                    ...
                    Local1 |= 0x00800000
                    Local1 |= 0x01000000
                    Local0 = ^^PCI0.SBRG.EC0.RR_M (0x07E7)
                    Name (BHFG, Zero)
                    BHFG = (Local0 & One)
                    If ((BHFG == One))
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x07E2, 0x50)
                        Local0 &= 0xBE
                        ^^PCI0.SBRG.EC0.WR_M (0x07E7, Local0)
                    }
                    ...
                    Local0 = ^^PCI0.SBRG.EC0.RR_M (0x07E2)
                    If ((Local0 == 0x80))
                    {
                        Local1 |= 0x0800
                    }
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x00100071))
                {
                    ...
                    If ((Local0 & One))
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x0E0C, 0xC8)
                    }
                    ElseIf ((Local0 & 0x04))
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x0E0C, 0xCD)
                    }
                    Else
                    {
                        Local1 = Zero
                ...
                {
                    Local0 = (IIA1 & 0xFF)
                    Local1 = ^^PCI0.SBRG.EC0.RR_M (0x9009)
                    If ((Local0 == Zero))
                    {
                    ...
                    ^^PCI0.SBRG.EC0.WR_M (0x9009, Local1)
                    LDNO = Arg1
                    Return (One)
                }
                ...
                If ((IIA0 == 0x0005002F))
                {
                    If ((KBBL == Zero))
                    {
                        Local1 = ^^PCI0.SBRG.EC0.RR_M (0x90C6)
                        Local1 &= 0xF7
                        ^^PCI0.SBRG.EC0.WR_M (0x90C6, Local1)
                    }
                ...
                If ((IIA0 == 0x00090031))
                {
                    ...
                    ^^PCI0.SBRG.EC0.WR_M (0x918E, Local0)
                    Return (One)
                }
                ...
                If ((IIA0 == 0x00120070))
                {
                    ...
                    Local0 &= One
                    Local1 = ^^PCI0.SBRG.EC0.RR_M (0x084C)
                    If (Local0)
                    {
                        Local1 |= 0x80
                        ^^PCI0.SBRG.EC0.WR_M (0x084C, Local1)
                    }
                ...
                If ((IIA0 == 0x0012007E))
                {
                    ...
                    Local2 = Zero
                    Local3 = Zero
                    ^^PCI0.SBRG.EC0.WR_M (0x0844, Zero)
                    ^^PCI0.SBRG.EC0.WR_M (0x0845, Zero)
                    If ((IIA2 == One))
                    {
                        Local1 |= 0x80
                    }
                    ...
                    Local0 = (IIA1 >> 0x10)
                    Local0 &= 0xFFFF
                    If (((Local0 & 0xFFF0) != 0xFFF0))
                    {
                        Local0 += 0x0A
                        Local0 = (Local0 * 0x3C)
                        Local2 = (Local0 & 0xFF)
                        Local3 = (Local0 >> 0x08)
                        ^^PCI0.SBRG.EC0.WR_M (0x0844, Local2)
                        ^^PCI0.SBRG.EC0.WR_M (0x0845, Local3)
                    }
                ...
                If ((IIA0 == 0x0012007F))
                {
                    ...
                    Local1 = (Local0 & 0xFF)
                    Local2 = (Local0 >> 0x08)
                    Local3 = ^^PCI0.SBRG.EC0.RR_M (0x0843)
                    Local3 |= 0x10
                    ^^PCI0.SBRG.EC0.WR_M (0x0843, Local3)
                    ^^PCI0.SBRG.EC0.WR_M (0x0846, Local1)
                    ^^PCI0.SBRG.EC0.WR_M (0x0847, Local2)
                    Local3 = ^^PCI0.SBRG.EC0.RR_M (0x0843)
                    Local3 &= 0xFFFFFFFFFFFFFFEF
                    ^^PCI0.SBRG.EC0.WR_M (0x0843, Local3)
                    Return (One)
                }
                ...
                If ((IIA0 == 0x00120057))
                {
                    Notify (^^PCI0.BAT0, 0x80) // Status Change
                    Return (SRSC (IIA1))
                }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        {
            P80H = 0xBA
            Notify (\_TZ.THM2, 0x81) // Thermal Trip Point Change
        ...
        {
            P80H = 0xE0
            Notify (\_TZ.FAN0, 0x80) // Status Change
        }
    }
    ...
    Scope (_SB.ATKD)
    {
        ...
        {
            ^^PCI0.SBRG.EC0.WR_M (0x07E2, Arg0)
            Local0 = ^^PCI0.SBRG.EC0.RR_M (0x07E7)
            If ((Arg0 == 0x80))
            {
                Local0 |= 0xC0
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (STTF, 0, Serialized)
        {
            ...
            M256 = 0x00034BC0
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.STTF.M256 */
            U1ML = M256 /* \_SB_.ATKD.STTF.M256 */
        }
        ...
        Method (SWDC, 0, Serialized)
        {
            ...
            M256 = 0x3A98
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.SWDC.M256 */
            U1ML = M256 /* \_SB_.ATKD.SWDC.M256 */
        }

        Method (SSDC, 0, Serialized)
        {
            Name (UTDP, Buffer (0x08) {})
            CreateWordField (UTDP, Zero, M254)
            CreateByteField (UTDP, 0x02, M255)
            ...
            M256 = 0x88B8
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.SSDC.M256 */
            U1ML = M256 /* \_SB_.ATKD.SSDC.M256 */
        }

        Method (TPDC, 0, Serialized)
        {
            Name (UTDP, Buffer (0x08) {})
            CreateWordField (UTDP, Zero, M254)
            CreateByteField (UTDP, 0x02, M255)
            ...
            M256 = 0x9C40
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.TPDC.M256 */
            U1ML = M256 /* \_SB_.ATKD.TPDC.M256 */
        }

        Method (SFDC, 0, Serialized)
        {
            Name (UTDP, Buffer (0x08) {})
            CreateWordField (UTDP, Zero, M254)
            CreateByteField (UTDP, 0x02, M255)
            ...
            M256 = 0x9C40
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.SFDC.M256 */
            U1ML = M256 /* \_SB_.ATKD.SFDC.M256 */
        }

        Method (RPGK, 0, Serialized)
        {
            Name (UTDP, Buffer (0x08) {})
            CreateWordField (UTDP, Zero, M254)
            CreateByteField (UTDP, 0x02, M255)
            ...
            M256 = 0x14
            ALIB (0x0C, UTDP)
            R1ML = M256 /* \_SB_.ATKD.RPGK.M256 */
            U1ML = M256 /* \_SB_.ATKD.RPGK.M256 */
        }
        ...
        Method (FANL, 1, Serialized)
        {
            ...
            FN_M = Arg0
            Local2 = Zero
            Local2 = (^^PCI0.SBRG.EC0.RR_M (0x06B3) & One)
            If (Local2)
            {
                Return (One)
            }
            Else
            {
                Switch (ToInteger (Local0))
                {
                    Case (One)
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x91AA, 0x0F)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AB, 0x19)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AC, 0x69)
                        ^^PCI0.SBRG.EC0.WR_M (0x91B0, 0x1E)
                        If (^^PCI0.SBRG.EC0.AP_S ())
                        {
                            SWDC ()
                            ^^PCI0.SBRG.EC0.ETPP (TPU1)
                            ^^PCI0.SBRG.EC0.WR_M (0x9091, One)
                            Local1 = Zero
                            Local1 = (^^PCI0.SBRG.EC0.RR_M (0x918E) & 0x7F)
                            ^^PCI0.SBRG.EC0.WR_M (0x918E, Local1)
                        }
                        Else
                        {
                            SWDC ()
                            ^^PCI0.SBRG.EC0.ETPP (TPU1)
                            ^^PCI0.SBRG.EC0.WR_M (0x9091, One)
                            ^^PCI0.SBRG.EC0.WR_M (0x918E, 0x82)
                        }
                    }
                    Case (0x02)
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x91AA, 0x28)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AB, 0x36)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AC, 0x73)
                        ^^PCI0.SBRG.EC0.WR_M (0x91B0, 0x41)
                        Local1 = Zero
                        Local1 = (^^PCI0.SBRG.EC0.RR_M (0x918E) & 0x7F)
                        ^^PCI0.SBRG.EC0.WR_M (0x918E, Local1)
                        If (^^PCI0.SBRG.EC0.AP_S ())
                        {
                            TPDC ()
                            ^^PCI0.SBRG.EC0.ETPP (TPU2)
                            ^^PCI0.SBRG.EC0.WR_M (0x9091, 0x02)
                        }
                        Else
                        {
                            TPDC ()
                    ...
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x91AA, 0x28)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AB, 0x28)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AC, 0x73)
                        ^^PCI0.SBRG.EC0.WR_M (0x91B0, 0x28)
                        Local1 = Zero
                        Local1 = (^^PCI0.SBRG.EC0.RR_M (0x918E) & 0x7F)
                        ^^PCI0.SBRG.EC0.WR_M (0x918E, Local1)
                        If (^^PCI0.SBRG.EC0.AP_S ())
                    ...
                    Default
                    {
                        ^^PCI0.SBRG.EC0.WR_M (0x91AA, 0x23)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AB, 0x36)
                        ^^PCI0.SBRG.EC0.WR_M (0x91AC, 0x69)
                        ^^PCI0.SBRG.EC0.WR_M (0x91B0, 0x41)
                        Local1 = Zero
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (GLKB, 1, NotSerialized)
        {
            ...
            ElseIf ((Arg0 == 0x02))
            {
                Local0 = ^^PCI0.SBRG.EC0.RR_M (0x9042)
                If ((Local0 != Zero))
                {
                    Local0 |= 0x80
                }
        ...
        Method (SLKB, 1, NotSerialized)
        {
            ...
            If (Local0)
            {
                ^^PCI0.SBRG.EC0.WR_M (0x9042, Local1)
            }
            Else
            {
                ^^PCI0.SBRG.EC0.WR_M (0x9042, Zero)
            }
        ...
        Method (SPTP, 1, NotSerialized)
        {
            ...
            If ((Arg0 == 0x02))
            {
                If ((OSYS >= 0x07DC))
                {
                    ^^PCI0.SBRG.EC0.WR_M (0x0470, 0x14)
                    ^^PCI0.SBRG.EC0.WR_M (0x0471, 0xE0)
                    ^^PCI0.SBRG.EC0.WR_M (0x0472, 0x1F)
                    ^^PCI0.SBRG.EC0.WR_M (0x0473, 0x5F)
                    ^^PCI0.SBRG.EC0.WR_M (0x0474, 0xF0)
                    ^^PCI0.SBRG.EC0.WR_M (0x0475, 0x5F)
                    ^^PCI0.SBRG.EC0.WR_M (0x0476, 0xE0)
                    ^^PCI0.SBRG.EC0.WR_M (0x0477, 0xF0)
                    ^^PCI0.SBRG.EC0.WR_M (0x0478, 0x1F)
                    ^^PCI0.SBRG.EC0.WR_M (0x0479, 0xF0)
                    ^^PCI0.SBRG.EC0.WR_M (0x047A, 0x14)
                    ^^PCI0.SBRG.EC0.EX_T (0xC1, 0x0B, Zero, Zero, Zero, Zero)
                }
            }
        ...
        OperationRegion (GPO0, SystemMemory, 0xFED81500, 0x1000)
        Field (GPO0, DWordAcc, NoLock, Preserve)
        {
            Offset (0x60), 
            GREG,   32
        }

        Method (GMML, 0, Serialized)
        {
            Local0 = GREG /* \_SB_.ATKD.GREG */
