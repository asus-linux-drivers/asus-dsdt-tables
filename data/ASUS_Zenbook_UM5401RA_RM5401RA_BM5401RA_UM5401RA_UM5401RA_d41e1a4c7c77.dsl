 ...
 *
 * Disassembly of /tmp/tmp.YCuvrSAPvo/Zenbook_UM5401RA_RM5401RA_BM5401RA_UM5401RA_UM5401RA_d41e1a4c7c77/Zenbook_UM5401RA_RM5401RA_BM5401RA_UM5401RA_UM5401RA, Sun May 24 12:31:46 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F466 (62566)
 *     Revision         0x02
 *     Checksum         0xDD
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x98205F18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x981F3000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (AECO, SystemMemory, AECB, 0x3A)
    ...
    Scope (_SB)
    {
        OperationRegion (AUMO, SystemMemory, AWMB, 0x4B)
        ...
        Device (ATKD)
        {
            ...
            Scope (\_SB.ATKD)
            {
                Method (FANL, 1, Serialized)
                {
                    ...
                    If (ACPF)
                    {
                        ^^PCI0.SBRG.EC0.STTM (0x0C, 0x000222E0)
                    }
                    Else
                    {
                        ^^PCI0.SBRG.EC0.STTM (0x0C, 0xB3B0)
                    }

                    ^^PCI0.SBRG.EC0.STTF (Zero)
                    TEMF = One
                    SMIF = 0x05
                    FANF = Arg0
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x0011001E))
                    {
                        Name (RBU2, Buffer (0x02)
                        {
                             0x00, 0x00                                       // ..
                        })
                        RBU2 = ^^PCI0.SBRG.EC0.ST8E (0x4F, Zero)
                        Local1 = DerefOf (RBU2 [Zero])
                        Local0 = Zero
                        If ((Local1 & 0x80))
                        {
                            Local0 |= 0x00010000
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00060078))
                    {
                        If ((CSIM == Zero))
                        {
                            ...
                            ^^PCI0.SBRG.EC0.ST9E (0x48, 0xFF, Local0)
                            Local1 = ^^PCI0.SBRG.EC0.ST8E (0x48, Zero)
                            If ((Local0 == Local1))
                            {
                                Return (One)
                            }
                    ...
                    If ((IIA0 == 0x0011001E))
                    {
                        If ((IIA1 == One))
                        {
                            Return (^^PCI0.SBRG.EC0.ST9E (0x4F, 0xFF, 0xC0))
                        }
                        Else
                        {
                            Return (^^PCI0.SBRG.EC0.ST9E (0x4F, 0xFF, 0x80))
                        }
                    }
        ...
        Method (CMIN, 1, Serialized)
        {
            ...
            Switch (ToInteger (Arg0))
            {
                Case (0x02)
                {
                    ...
                    If ((TEM1 >= TEM2))
                    {
                        CPL2 = TEM2 /* \_SB_.PCI0.SBRG.EC0_.CMIN.TEM2 */
                    }
                    Else
                    {
                        CPL2 = TEM1 /* \_SB_.PCI0.SBRG.EC0_.CMIN.TEM1 */
                    }
                }
                Case (0x04)
                {
                    ...
                    If ((TEM1 >= TEM2))
                    {
                        CPL4 = TEM2 /* \_SB_.PCI0.SBRG.EC0_.CMIN.TEM2 */
                    }
                    Else
                    {
                        CPL4 = TEM1 /* \_SB_.PCI0.SBRG.EC0_.CMIN.TEM1 */
                    }
                }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (_QC0, 0, Serialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            ...
            ElseIf (((0x02 & Local0) == 0x02))
            {
                Local1 = 0x02
            }
            ElseIf (((0x02 & Local0) == 0x08))
            {
                Local1 = 0x03
            }
            ElseIf (((0x02 & Local0) == Zero))
            {
                If (((0x08 & Local0) == One))
                {
                    Local1 = One
                }
                ElseIf (((0x08 & Local0) == 0x02))
                {
                    Local1 = 0x02
                }
                ElseIf (((0x08 & Local0) == 0x08))
                {
                    Local1 = 0x03
                }
                ElseIf (((0x08 & Local0) == Zero))
                {
                    If (((One & Local0) == One))
                    {
                        Local1 = One
                    }
                    ElseIf (((One & Local0) == 0x02))
                    {
                        Local1 = 0x02
                    }
                    ElseIf (((One & Local0) == 0x08))
                    {
                        Local1 = 0x03
                    }
                }
    ...
    Scope (_SB.PCI0.GPP6.WLAN)
    {
        Method (MTDS, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                If ((MDSE >= One))
                {
                    MDS6 [0x04] = MDSE /* \_SB_.MDSE */
                    MDS6 [0x06] = MDSN /* \_SB_.MDSN */
                    MDS6 [0x07] = MD1T /* \_SB_.MD1T */
                    MDS6 [0x08] = MD10 /* \_SB_.MD10 */
                    MDS6 [0x09] = MD11 /* \_SB_.MD11 */
                    MDS6 [0x0A] = MD12 /* \_SB_.MD12 */
                    MDS6 [0x0B] = MD13 /* \_SB_.MD13 */
                    MDS6 [0x0C] = MD14 /* \_SB_.MD14 */
                    MDS6 [0x0D] = MD15 /* \_SB_.MD15 */
                    MDS6 [0x0E] = MD16 /* \_SB_.MD16 */
                    MDS6 [0x0F] = MD17 /* \_SB_.MD17 */
                    MDS6 [0x10] = MD18 /* \_SB_.MD18 */
                    MDS6 [0x11] = MD19 /* \_SB_.MD19 */
                    MDS6 [0x12] = MD1A /* \_SB_.MD1A */
                    MDS6 [0x13] = MD2T /* \_SB_.MD2T */
                    MDS6 [0x14] = MD20 /* \_SB_.MD20 */
                    MDS6 [0x15] = MD21 /* \_SB_.MD21 */
                    MDS6 [0x16] = MD22 /* \_SB_.MD22 */
                    MDS6 [0x17] = MD23 /* \_SB_.MD23 */
                    MDS6 [0x18] = MD24 /* \_SB_.MD24 */
                    MDS6 [0x19] = MD25 /* \_SB_.MD25 */
                    MDS6 [0x1A] = MD26 /* \_SB_.MD26 */
                    MDS6 [0x1B] = MD27 /* \_SB_.MD27 */
                    MDS6 [0x1C] = MD28 /* \_SB_.MD28 */
                    MDS6 [0x1D] = MD29 /* \_SB_.MD29 */
                    MDS6 [0x1E] = MD2A /* \_SB_.MD2A */
                }

                Return (MDS6) /* \_SB_.PCI0.GPP6.WLAN.MTDS.MDS6 */
            }
            Else
            {
        ...
        Method (MTGS, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                If ((MDSE >= One))
                {
                    MGS6 [0x04] = MGSV /* \_SB_.MGSV */
                    MGS6 [0x06] = MGSN /* \_SB_.MGSN */
                    MGS6 [0x07] = MGS1 /* \_SB_.MGS1 */
                    MGS6 [0x08] = MG10 /* \_SB_.MG10 */
                    MGS6 [0x09] = MG11 /* \_SB_.MG11 */
                    MGS6 [0x0A] = MG12 /* \_SB_.MG12 */
                    MGS6 [0x0B] = MG13 /* \_SB_.MG13 */
                    MGS6 [0x0C] = MG14 /* \_SB_.MG14 */
                    MGS6 [0x0D] = MG15 /* \_SB_.MG15 */
                    MGS6 [0x0E] = MGS2 /* \_SB_.MGS2 */
                    MGS6 [0x0F] = MG20 /* \_SB_.MG20 */
                    MGS6 [0x10] = MG21 /* \_SB_.MG21 */
                    MGS6 [0x11] = MG22 /* \_SB_.MG22 */
                    MGS6 [0x12] = MG23 /* \_SB_.MG23 */
                    MGS6 [0x13] = MG24 /* \_SB_.MG24 */
                    MGS6 [0x14] = MG25 /* \_SB_.MG25 */
                    MGS6 [0x15] = MGS3 /* \_SB_.MGS3 */
                    MGS6 [0x16] = MG30 /* \_SB_.MG30 */
                    MGS6 [0x17] = MG31 /* \_SB_.MG31 */
                    MGS6 [0x18] = MG32 /* \_SB_.MG32 */
                    MGS6 [0x19] = MG33 /* \_SB_.MG33 */
                    MGS6 [0x1A] = MG34 /* \_SB_.MG34 */
                    MGS6 [0x1B] = MG35 /* \_SB_.MG35 */
                    MGS6 [0x1C] = MGS4 /* \_SB_.MGS4 */
                    MGS6 [0x1D] = MG40 /* \_SB_.MG40 */
                    MGS6 [0x1E] = MG41 /* \_SB_.MG41 */
                    MGS6 [0x1F] = MG42 /* \_SB_.MG42 */
                    MGS6 [0x20] = MG43 /* \_SB_.MG43 */
                    MGS6 [0x21] = MG44 /* \_SB_.MG44 */
                    MGS6 [0x22] = MG45 /* \_SB_.MG45 */
                    MGS6 [0x23] = MGS5 /* \_SB_.MGS5 */
                    MGS6 [0x24] = MG50 /* \_SB_.MG50 */
                    MGS6 [0x25] = MG51 /* \_SB_.MG51 */
                    MGS6 [0x26] = MG52 /* \_SB_.MG52 */
                    MGS6 [0x27] = MG53 /* \_SB_.MG53 */
                    MGS6 [0x28] = MG54 /* \_SB_.MG54 */
                    MGS6 [0x29] = MG55 /* \_SB_.MG55 */
                }

                Return (MGS6) /* \_SB_.PCI0.GPP6.WLAN.MTGS.MGS6 */
            }
            Else
            {
        ...
        Method (MTCL, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                If ((MDSE >= One))
                {
                    MCSB [0x04] = MCSV /* \_SB_.MCSV */
                    MCSB [0x05] = MCS6 /* \_SB_.MCS6 */
                    MCSB [0x06] = MC01 /* \_SB_.MC01 */
                    MCSB [0x07] = MC02 /* \_SB_.MC02 */
                    MCSB [0x08] = MC03 /* \_SB_.MC03 */
                    MCSB [0x09] = MC04 /* \_SB_.MC04 */
                    MCSB [0x0A] = MC05 /* \_SB_.MC05 */
                    MCSB [0x0B] = MC06 /* \_SB_.MC06 */
                }

                Return (MCSB) /* \_SB_.PCI0.GPP6.WLAN.MTCL.MCSB */
            }
            Else
            {
                Return (Zero)
        ...
        Method (MTCC, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                If ((MDSE >= One))
                {
                    MCSS [0x04] = MCCF /* \_SB_.MCCF */
                    MCSS [0x05] = MCC1 /* \_SB_.MCC1 */
                    MCSS [0x06] = MCC2 /* \_SB_.MCC2 */
                }

                Return (MCSS) /* \_SB_.PCI0.GPP6.WLAN.MTCC.MCSS */
            }
            Else
            {
                Return (Zero)
