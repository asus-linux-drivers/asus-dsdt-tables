 ...
 *
 * Disassembly of /tmp/tmp.e5oIvBp5IU/VivoBook_ASUSLaptop_E210MAB_E210MA_c18106dc5ac0_2/VivoBook_ASUSLaptop_E210MAB_E210MA, Tue Sep 15 09:40:22 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010F68 (69480)
 *     Revision         0x02
 *     Checksum         0xA1
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x79AB1098, 0x044F)
    ...
    Scope (_SB.PCI0.RP01.PXSX)
    {
        ...
        Method (RWGS, 0, Serialized)
        {
            ...
            Return (RWGY) /* \_SB_.PCI0.RP01.PXSX.RWGS.RWGY */
        }
    }
    ...
    Scope (_SB.PCI0.RP01.PXSX)
    {
        Method (MTDS, 0, Serialized)
        {
            ...
            Return (MDSB) /* \_SB_.PCI0.RP01.PXSX.MTDS.MDSB */
        }
        ...
        Method (MTGS, 0, Serialized)
        {
            ...
            Return (MGSB) /* \_SB_.PCI0.RP01.PXSX.MTGS.MGSB */
        }
    }
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x79AB4000, 0x0100)
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        OperationRegion (GP19, SystemMemory, 0xD0C40730, 0x08)
        Field (GP19, AnyAcc, NoLock, Preserve)
        {
            GR19,   1
        }

        OperationRegion (G120, SystemMemory, 0xD0C508C0, 0x08)
        Field (G120, AnyAcc, NoLock, Preserve)
        {
            R120,   32
        }

        OperationRegion (GP09, SystemMemory, 0xD0C40690, 0x08)
        Field (GP09, AnyAcc, NoLock, Preserve)
        {
            Offset (0x01), 
            GR09,   1
        }
    ...
    Scope (_SB.PCI0.SPI2)
    {
        Device (FPRT)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                {
                    GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly,
                        "\\_SB.GPO1", 0x00, ResourceConsumer, _Y0F,
                        )
                        {   // Pin list
                            0x0000
                        }
                ...
                CreateDWordField (BBUF, \_SB.PCI0.SPI2.FPRT._CRS._Y0E._SPE, SPEX)  // _SPE: Speed
                CreateWordField (RBUF, 0x17, RST0)
                CreateByteField (RBUF, \_SB.PCI0.SPI2.FPRT._CRS._Y0F._PPI, PCG0)  // _PPI: Pin Configuration
