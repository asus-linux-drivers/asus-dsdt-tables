 ...
 *
 * Disassembly of /tmp/tmp.W11lRqaUXQ/ASUS_EXPERTBOOK_L1400CDAY_L1400CDA_3a3807bc0cd4_2/ASUS_EXPERTBOOK_L1400CDAY_L1400CDA, Tue Jun 16 18:54:09 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CDA9 (52649)
 *     Revision         0x02
 *     Checksum         0xD5
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCCDD4000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCCDD8000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD110510)
    Name (FTPM, 0xFD110510)
    Name (PPIM, 0xCD026F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            ...
            Else
            {
                ...
                ElseIf ((TTPF == One))
                {
                    ...
                    ElseIf ((TCID == 0x1B4E))
                    {
                        CreateDWordField (CRE1, \_SB.TPM._Y24._INT, LIR1)  // _INT: Interrupts
                        LIR1 = TMRQ /* \_SB_.TPM_.TMRQ */
                        Return (CRE1) /* \_SB_.TPM_.CRE1 */
                    }
                    Else
                    {
                        CreateWordField (CRE2, 0x23, LIR2)
                        CreateBitField (CRE2, \_SB.TPM._Y25._POL, LLV2)  // _POL: Polarity
                        LIR2 = TMRQ /* \_SB_.TPM_.TMRQ */
                        LLV2 = TLVL /* \_SB_.TPM_.TLVL */
                        Return (CRE2) /* \_SB_.TPM_.CRE2 */
                    }
                }
                ElseIf ((TTPF == Zero))
                {
        ...
        Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
        {
            If (((TMRQ != Zero) && (TMRQ != 0xFFFFFFFF)))
            {
                If ((TCID == 0x1B4E))
                {
                    CreateDWordField (Arg0, 0x11, IRQ1)
                    CreateDWordField (CRE1, \_SB.TPM._Y24._INT, LIR1)  // _INT: Interrupts
                    LIR1 = IRQ1 /* \_SB_.TPM_._SRS.IRQ1 */
                    TMRQ = IRQ1 /* \_SB_.TPM_._SRS.IRQ1 */
                    CreateBitField (Arg0, 0x79, ITR1)
                    CreateBitField (CRE1, \_SB.TPM._Y24._HE, LTR1)  // _HE_: High-Edge
                    LTR1 = ITR1 /* \_SB_.TPM_._SRS.ITR1 */
                    CreateBitField (Arg0, 0x7A, ILV1)
                    CreateBitField (CRE1, \_SB.TPM._Y24._LL, LLV1)  // _LL_: Low Level
                }
                Else
                {
                    CreateWordField (Arg0, 0x23, IRQ2)
                    CreateWordField (CRE2, 0x23, LIR2)
                    LIR2 = IRQ2 /* \_SB_.TPM_._SRS.IRQ2 */
                    TMRQ = IRQ2 /* \_SB_.TPM_._SRS.IRQ2 */
                    CreateBitField (Arg0, 0x98, ITR2)
                    CreateBitField (CRE2, \_SB.TPM._Y25._MOD, LTR2)  // _MOD: Mode
                    LTR2 = ITR2 /* \_SB_.TPM_._SRS.ITR2 */
                    CreateBitField (Arg0, 0x99, ILV2)
                    CreateBitField (CRE2, \_SB.TPM._Y25._POL, LLV2)  // _POL: Polarity
                }

                If ((TCID == 0x1B4E))
                {
                    LLV1 = ILV1 /* \_SB_.TPM_._SRS.ILV1 */
                }
                Else
                {
                    LLV2 = ILV2 /* \_SB_.TPM_._SRS.ILV2 */
                }
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xCD010000, 0x0100)
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    {
                        Name (PUNM, Zero)
                        PUNM = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                        Name (BPDI, Buffer (0x0A) {})
                        CreateWordField (BPDI, Zero, PDST)
                        CreateDWordField (BPDI, 0x02, ASPT)
                        CreateDWordField (BPDI, 0x06, DGST)
                        PDST = Zero
                        ASPT = Zero
                        DGST = Zero
                        If ((PUNM == Zero))
                        ...
                        ^^PCI0.SBRG.EC0.WP2E (0x40, 0x02)
                        ^^PCI0.SBRG.EC0.WP2E (0x41, PUNM)
                        ^^PCI0.SBRG.EC0.WP2E (0x6F, 0x20)
                        ^^PCI0.SBRG.EC0.WP2E (0x6E, 0x0B)
                        Local0 = 0xC8
                        While ((Local0 && ((^^PCI0.SBRG.EC0.BCLB & 0x80) != 0x80)))
                        {
                            Stall (0x64)
                            Local0--
                        }
                        ...
                        If (Local0)
                        {
                            PDST = ^^PCI0.SBRG.EC0.RP2E (0x42)
                            PDST |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x43) << 0x08)
                            ASPT = ^^PCI0.SBRG.EC0.RP2E (0x44)
                            ASPT |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x45) << 0x08)
                            ASPT |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x46) << 0x10)
                            ASPT |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x47) << 0x18)
                            DGST = ^^PCI0.SBRG.EC0.RP2E (0x48)
                            DGST |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x49) << 0x08)
                            DGST |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x4A) << 0x10)
                            DGST |= (Local1 = ^^PCI0.SBRG.EC0.RP2E (0x4B) << 0x18)
                        }

                        ^^PCI0.SBRG.EC0.BCLB = 0x40
                        Return (BPDI) /* \_SB_.ATKD.WMNB.BPDI */
                    }
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT1._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x07
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT1._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT2._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x08
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT2._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT3._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x09
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT3._PLD.PLD1 */
                    }
                }
                ...
                Device (PRT4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT4._UPC.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        CreateField (DerefOf (PLD1 [Zero]), 0x57, 0x08, GPO1)
                        GPO1 = 0x0A
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT4._PLD.PLD1 */
                    }
                }
            }
            ...
            Device (PRT5)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    If (RV2I)
                    {
                        Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT5._UPC.UPC2 */
                    }
                    Else
                    {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    CreateField (DerefOf (PLD2 [Zero]), 0x40, One, VIS2)
                    VIS2 = Zero
                    CreateField (DerefOf (PLD2 [Zero]), 0x57, 0x08, GPO2)
                    GPO2 = 0x05
                    If (RV2I)
                    {
                        Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT5._PLD.PLD2 */
                    }
                    Else
                    {
            ...
            Device (PRT6)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    If (RV2I)
                    {
                        Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6._UPC.UPC2 */
                    }
                    Else
                    {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    If (RV2I)
                    {
                        Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT6._PLD.PLD2 */
                    }
                    Else
                    {
            ...
            Device (PRT7)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    If (RV2I)
                    {
                        Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT7._UPC.UPC2 */
                    }
                    Else
                    {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    If (RV2I)
                    {
                        Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT7._PLD.PLD2 */
                    }
                    Else
                    {
            ...
            Device (PRT8)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    If (RV2I)
                    {
                        Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT8._UPC.UPC2 */
                    }
                    Else
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT8._UPC.UPC1 */
                    }
                }
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    If (RV2I)
                    {
                        Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT8._PLD.PLD2 */
                    }
                    Else
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT8._PLD.PLD1 */
                    }
                }
            }
            ...
            Device (PRT9)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT9._UPC.UPC2 */
                }
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    CreateField (DerefOf (PLD2 [Zero]), 0x57, 0x08, GPO2)
                    GPO2 = 0x03
                    Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT9._PLD.PLD2 */
                }
            }
            ...
            Device (PRTA)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    ...
                    Return (UPC2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRTA._UPC.UPC2 */
                }
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    CreateField (DerefOf (PLD2 [Zero]), 0x57, 0x08, GPO2)
                    GPO2 = 0x04
                    Return (PLD2) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRTA._PLD.PLD2 */
                }
            }
        }
    }
    ...
    Scope (_SB.PCI0.GP17.XHC0.RHUB.PRT1.PRT2)
    {
        ...
        Device (DCAM)
        {
            ...
            {
                Return (CAPD) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT1.PRT2.CAPD */
            }
        }
    }
    ...
    Scope (_SB.PCI0.GPP1.WLAN)
    {
        Method (RWRD, 0, Serialized)
        {
            ...
            Return (RWRY) /* \_SB_.PCI0.GPP1.WLAN.RWRD.RWRY */
        }
        ...
        Method (RWGS, 0, Serialized)
        {
            ...
            Return (RWGY) /* \_SB_.PCI0.GPP1.WLAN.RWGS.RWGY */
        }
    }
    ...
    Scope (_SB.PCI0.GPP1.WLAN)
    {
        ...
        Method (WRDS, 0, Serialized)
        {
            ...
            Return (WRDY) /* \_SB_.PCI0.GPP1.WLAN.WRDY */
        }
        ...
        Method (EWRD, 0, Serialized)
        {
            ...
            Return (EWRY) /* \_SB_.PCI0.GPP1.WLAN.EWRY */
        }
        ...
        Method (WGDS, 0, Serialized)
        {
            ...
            Return (WGDY) /* \_SB_.PCI0.GPP1.WLAN.WGDY */
        }
    }
    ...
    Scope (_SB.PCI0.GPP1.WLAN)
    {
        Method (MTDS, 0, Serialized)
        {
            ...
            Return (MDSB) /* \_SB_.PCI0.GPP1.WLAN.MTDS.MDSB */
        }
        ...
        Method (MTGS, 0, Serialized)
        {
            ...
            Return (MGSB) /* \_SB_.PCI0.GPP1.WLAN.MTGS.MGSB */
        }
    }
}
