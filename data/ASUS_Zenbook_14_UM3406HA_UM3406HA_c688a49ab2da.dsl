 ...
 *
 * Disassembly of /tmp/tmp.zu1S9lRCNZ/ASUS_Zenbook_14_UM3406HA_UM3406HA_c688a49ab2da/ASUS_Zenbook_14_UM3406HA_UM3406HA, Thu May 14 13:50:20 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000108F5 (67829)
 *     Revision         0x02
 *     Checksum         0x7C
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x97002F18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x96FEF000, 0x0100)
    ...
    Scope (_SB.PCI0.GPP6.WLAN)
    {
        ...
        Method (MTFG, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MFG6) /* \_SB_.PCI0.GPP6.WLAN.MTFG.MFG6 */
            }
            Else
            {
                Return (Zero)
        ...
        Method (MTAS, 0, Serialized)
        {
            If ((MD6G == One))
            {
                ...
                Return (MTA6) /* \_SB_.PCI0.GPP6.WLAN.MTAS.MTA6 */
            }
            Else
            {
                Return (Zero)
