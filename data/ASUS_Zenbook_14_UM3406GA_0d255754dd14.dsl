 ...
 *
 * Disassembly of /tmp/tmp.u8Q9NxHY8O/Zenbook_14_UM3406GA_0d255754dd14_2/Zenbook_14_UM3406GA, Wed May 27 20:21:53 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000123A5 (74661)
 *     Revision         0x02
 *     Checksum         0x60
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Name (MAL, 0x0000007AC0000000)
            Name (MAM, 0x000000833FFFFFFF)
            Name (NRSB, 0x71E66000)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x71E65000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (AMTO, SystemMemory, AWMT, 0x13)
        Field (AMTO, AnyAcc, NoLock, Preserve)
        {
            Offset (0x00), 
            AMPT,   32, 
            Offset (0x04), 
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (HTDD, 4, Serialized)
        {
            ...
            Local0 [0x02] = Arg2
            Local1 = Arg3
            Local2 = KBCS (0x03, 0xDD, Local0, Local1)
            Return (Local2)
        }
        ...
        Method (FRPM, 1, Serialized)
        {
            ...
            {
                Acquire (MU4T, 0xFFFF)
                HTDD (0x82, 0x32, Arg0, Zero)
                Local0 = HTDD (0x02, 0x33, Zero, One)
                Local1 = HTDD (0x02, 0x34, Zero, One)
                Local1 <<= 0x08
                Local1 |= Local0
                Release (MU4T)
                Return (Local1)
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00110035))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.HTDD (0x02, 0x30, Zero, One)
                        If ((Local0 > Zero))
                        {
                            Local1 = ^^PCI0.SBRG.EC0.FRPM (Zero)
                            Local1 /= 0x64
                            Local1 += 0x00010000
                            LFAN [Zero] = Local1
                        }
                        ...
                        If ((Local0 > 0x02))
                        {
                            Local3 = ^^PCI0.SBRG.EC0.FRPM (0x02)
                            Local3 /= 0x64
                            Local3 += 0x00010000
                            LFAN [0x03] = Local3
                        }
                    ...
                    If ((IIA0 == 0x00120057))
                    {
                        Name (BCMV, Buffer (0x08)
                        {
                             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                        })
                        CreateDWordField (BCMV, Zero, BCML)
                        CreateDWordField (BCMV, 0x04, BCMH)
                        Name (RBU1, Buffer (0x03)
                        {
                             0x00, 0x00, 0x00                                 // ...
                        })
                        RBU1 = ^^PCI0.SBRG.EC0.REBC (0x05, 0x03)
                    ...
                    If ((IIA0 == 0x001200F1))
                    {
                        Local1 = ^^PCI0.SBRG.EC0.STDD (0x08, 0x1D, 0xFF)
                        If (((Local1 >> 0x07) == One))
                        {
                            Return (0x00010000)
                        }
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00060059))
                    {
                        ...
                        If ((One == ECRF))
                        {
                            Return (^^PCI0.SBRG.EC0.REBS (Local0, 0x2E, RLEN, ECSS))
                        }
                    }
                    ...
                    If ((IIA0 == 0x001200F1))
                    {
                        If ((IIA1 == Zero))
                        {
                            ^^PCI0.SBRG.EC0.STDD (0x88, 0x1D, Zero)
                        }
                        Else
                        {
                            ^^PCI0.SBRG.EC0.STDD (0x88, 0x1D, One)
                        }
    ...
    Scope (_SB.PCI0.GPP5.WLAN)
    {
        ...
        Method (MTVP, 0, Serialized)
        {
            If ((MD6G == One))
            {
                Name (MTV6, Package (0x13)
                {
                    0x4D, 
                    0x54, 
                    0x56, 
                ...
                If ((MDSE >= One))
                {
                    MTV6 [0x04] = MVPV /* \_SB_.MVPV */
                    MTV6 [0x05] = MVST /* \_SB_.MVST */
                    MTV6 [0x06] = MVS1 /* \_SB_.MVS1 */
                    MTV6 [0x07] = MVS2 /* \_SB_.MVS2 */
                    MTV6 [0x08] = MVS3 /* \_SB_.MVS3 */
                    MTV6 [0x09] = MVS4 /* \_SB_.MVS4 */
                    MTV6 [0x0A] = MVS5 /* \_SB_.MVS5 */
                    MTV6 [0x0B] = MVS6 /* \_SB_.MVS6 */
                    MTV6 [0x0C] = MVAP /* \_SB_.MVAP */
                    MTV6 [0x0D] = MVA1 /* \_SB_.MVA1 */
                    MTV6 [0x0E] = MVA2 /* \_SB_.MVA2 */
                    MTV6 [0x0F] = MVA3 /* \_SB_.MVA3 */
                    MTV6 [0x10] = MVA4 /* \_SB_.MVA4 */
                    MTV6 [0x11] = MVA5 /* \_SB_.MVA5 */
                    MTV6 [0x12] = MVA6 /* \_SB_.MVA6 */
                }

                Return (MTV6) /* \_SB_.PCI0.GPP5.WLAN.MTVP.MTV6 */
            }
            Else
            {
                Return (Zero)
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPPX.SPCF (SBUS = %x )\n", Arg0, Zero, Zero, Zero, Zero, Zero)
            M232 (0x5A, Arg0, Zero)
        }
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPPX.UPWD (SBUS = %x )\n", Arg0, Zero, Zero, Zero, Zero, Zero)
            M232 (0x5B, Arg0, Zero)
        }
    }
    ...
    Scope (_SB.I2CB)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "10431584")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
