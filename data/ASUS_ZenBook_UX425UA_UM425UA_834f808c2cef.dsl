 ...
 *
 * Disassembly of /tmp/tmp.XHgqSGhPB4/ZenBook_UX425UA_UM425UA_834f808c2cef/ZenBook_UX425UA_UM425UA, Tue Jul 28 17:27:21 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CFB0 (53168)
 *     Revision         0x02
 *     Checksum         0x01
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCAE1D000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCAE21000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC4DAC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCC4DAB18, 0x0C)
    ...
    OperationRegion (EXBU, SystemMemory, 0xCB386A98, 0x024D)
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (SCDG, 2, NotSerialized)
        {
            ...
            If ((Arg0 == One))
            {
                ...
                TDD2 [0x7F] = DA7F /* \DA7F */
                TDD2 [0x80] = DA80 /* \DA80 */
                Return (TDD2) /* \_SB_.ATKD.SCDG.TDD2 */
            }
