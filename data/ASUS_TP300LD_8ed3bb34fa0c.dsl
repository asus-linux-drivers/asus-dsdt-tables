 ...
 *
 * Disassembly of /tmp/tmp.mB5UntO56i/TP300LD_8ed3bb34fa0c_2/TP300LD, Fri Jun 12 09:45:52 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00016144 (90436)
 *     Revision         0x02
 *     Checksum         0x61
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCAB18C18, 0x02B2)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (ACC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                Return (BUF2) /* \_SB_.PCI0.ACC_.BUF2 */
            }
        ...
        Scope (I2C0)
        {
            ...
            Device (SHUB)
            {
                ...
                {
                    Return (CNF0) /* \_SB_.PCI0.I2C0.SHUB.CNF0 */
                }
            }
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (KBEN, 1, NotSerialized)
            {
                If ((Arg0 == Zero))
                {
                    Local0 = ^^PCI0.LPCB.EC0.ST8E (0x32, Zero)
                    Local0 |= 0x80
                    ^^PCI0.LPCB.EC0.ST9E (0x32, 0xFF, Local0)
                    Return (One)
                }
    ...
    Scope (_SB.PCI0.EHC1.HUBN.PR01.PR15)
    {
        ...
        Device (DCAM)
        {
            ...
            {
                Return (CAPD) /* \_SB_.PCI0.EHC1.HUBN.PR01.PR15.CAPD */
            }
        }
    }
