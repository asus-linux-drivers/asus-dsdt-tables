 ...
 *
 * Disassembly of /tmp/tmp.Vhrc7qkMth/ZenBook_UX425UAZ_UM425UAZ_a74ad6cd0220/ZenBook_UX425UAZ_UM425UAZ, Sat Aug 22 21:15:34 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CC03 (52227)
 *     Revision         0x02
 *     Checksum         0xA1
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBAE1D000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBAE21000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC4DAC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC4DAB18, 0x0C)
    ...
    Scope (_SB.PCI0)
    {
        Scope (GPP0)
        {
            ...
            Device (WLAN)
            {
                ...
                OperationRegion (WFDT, SystemMemory, 0xFED81522, One)
                Field (WFDT, ByteAcc, NoLock, Preserve)
                {
                    WFST,   1
                }
                ...
                {
                    Return (WRD1) /* \_SB_.PCI0.GPP0.WLAN.WRD1 */
                }
    ...
    OperationRegion (EXBU, SystemMemory, 0xBB382A98, 0x0251)
