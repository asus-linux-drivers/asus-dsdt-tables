 ...
 *
 * Disassembly of /tmp/tmp.cmlVGOFCtV/ProArt_P16_H7606WX_H7606WX_f72dad3a4293/ProArt_P16_H7606WX_H7606WX, Tue May 19 18:54:18 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000104AF (66735)
 *     Revision         0x02
 *     Checksum         0x02
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.LICL, IntObj)
        ...
        Method (WMNB, 3, Serialized)
        {
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x001200F1))
                {
                    ...
                    If ((Local0 == Zero))
                    {
                        ^^PCI0.SBRG.EC0.LICL = Zero
                    }
                    Else
                    {
                        ^^PCI0.SBRG.EC0.LICL = One
                    }
    ...
    Scope (_SB.I2CC)
    {
        ...
        {
            Name (_ADR, Zero)  // _ADR: Address
            Name (_HID, "WDHT2602")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, Zero)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
