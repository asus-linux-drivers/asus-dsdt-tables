 ...
 *
 * Disassembly of /tmp/tmp.cmlVGOFCtV/ROG_Flow_X16_GV601RW_GV601RW_ef4ea7980cff/ROG_Flow_X16_GV601RW_GV601RW, Tue May 19 18:54:20 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000115EF (71151)
 *     Revision         0x02
 *     Checksum         0x49
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB3E85000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB3E89000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB920FF98)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB9212D18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xB9213000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (ACPO, SystemMemory, ACPB, 0x13)
    ...
    Scope (_SB)
    {
        OperationRegion (ASBT, SystemMemory, ABTB, 0x51)
        Field (ASBT, AnyAcc, NoLock, Preserve)
        {
            ABTS,   32, 
            BVID,   16, 
            BSTE,   8, 
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00110033))
                    {
                        Return (^^PCI0.SBRG.EC0.GFLB (0x28))
                    }
                    ...
                    If ((IIA0 == 0x00110013))
                    {
                        ...
                        Local0 /= 0x64
                        Local1 = ^^PCI0.SBRG.EC0.RRAM (0xCC, 0x30)
                        If (((Local1 & 0x40) == 0x40))
                        {
                            Local0 |= 0x00080000
                        }
                    ...
                    If ((IIA0 == 0x00110014))
                    {
                        ...
                        Local0 /= 0x64
                        Local1 = ^^PCI0.SBRG.EC0.RRAM (0xCC, 0x37)
                        If (((Local1 & 0x40) == 0x40))
                        {
                            Local0 |= 0x00080000
                        }
                    ...
                    If ((IIA0 == 0x00110031))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.RTAH (0x02)
                        Local0 /= 0x64
                        Local1 = ^^PCI0.SBRG.EC0.RRAM (0xCC, 0x0130)
                        If (((Local1 & 0x40) == 0x40))
                        {
                            Local0 |= 0x00080000
                        }
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00110032))
                    {
                        Return (^^PCI0.SBRG.EC0.SUFC (IIA1, IIA2, IIA3, IIA4, 0x48))
                    }
                    ...
                    If ((IIA0 == 0x00110031))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.RRAM (0xCC, 0x0130)
                        If ((IIA1 == Zero))
                        {
                            Local1 = (Local0 & 0xFFFFFFFFFFFFFFBF)
                        }
                        ...
                        ^^PCI0.SBRG.EC0.WRAM (0xCD, 0x0130, Local1)
                        Return (One)
                    }
        ...
        If ((TPDF == One))
        {
            Device (FTPD)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBFI) /* \_SB_.I2CB.FTPD._CRS.SBFI */
                }
            }
        }
    }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (RTAH, 1, NotSerialized)
        {
            ...
            ElseIf ((Arg0 == 0x02))
            {
                ...
                {
                    BRAH = 0xC9
                    Local0 = THH2 /* \_SB_.PCI0.SBRG.EC0_.THH2 */
                    Local0 <<= 0x08
                    Local1 = THL2 /* \_SB_.PCI0.SBRG.EC0_.THL2 */
                    Local0 |= Local1
                    Release (CMUT)
                }
            }
    ...
    Scope (_SB.PCI0.GP17.XHC0.RHUB.PRT4)
    {
        ...
        Method (MTBT, 0, Serialized)
        {
            If ((BSTE == One))
            {
                MTBX [0x04] = BTRV /* \_SB_.BTRV */
                MTBX [0x06] = BTNR /* \_SB_.BTNR */
                MTBX [0x08] = BT11 /* \_SB_.BT11 */
                MTBX [0x09] = BT12 /* \_SB_.BT12 */
                MTBX [0x0A] = BT13 /* \_SB_.BT13 */
                MTBX [0x0B] = BT14 /* \_SB_.BT14 */
                MTBX [0x0C] = BT15 /* \_SB_.BT15 */
                MTBX [0x0D] = BT16 /* \_SB_.BT16 */
                MTBX [0x0F] = BT21 /* \_SB_.BT21 */
                MTBX [0x10] = BT22 /* \_SB_.BT22 */
                MTBX [0x11] = BT23 /* \_SB_.BT23 */
                MTBX [0x12] = BT24 /* \_SB_.BT24 */
                MTBX [0x13] = BT25 /* \_SB_.BT25 */
                MTBX [0x14] = BT26 /* \_SB_.BT26 */
                MTBX [0x16] = BT31 /* \_SB_.BT31 */
                MTBX [0x17] = BT32 /* \_SB_.BT32 */
                MTBX [0x18] = BT33 /* \_SB_.BT33 */
                MTBX [0x19] = BT34 /* \_SB_.BT34 */
                MTBX [0x1A] = BT35 /* \_SB_.BT35 */
                MTBX [0x1B] = BT36 /* \_SB_.BT36 */
                MTBX [0x1D] = BT41 /* \_SB_.BT41 */
                MTBX [0x1E] = BT42 /* \_SB_.BT42 */
                MTBX [0x1F] = BT43 /* \_SB_.BT43 */
                MTBX [0x20] = BT44 /* \_SB_.BT44 */
                MTBX [0x21] = BT45 /* \_SB_.BT45 */
                MTBX [0x22] = BT46 /* \_SB_.BT46 */
                MTBX [0x24] = BT51 /* \_SB_.BT51 */
                MTBX [0x25] = BT52 /* \_SB_.BT52 */
                MTBX [0x26] = BT53 /* \_SB_.BT53 */
                MTBX [0x27] = BT54 /* \_SB_.BT54 */
                MTBX [0x28] = BT55 /* \_SB_.BT55 */
                MTBX [0x29] = BT56 /* \_SB_.BT56 */
                MTBX [0x2B] = BT61 /* \_SB_.BT61 */
                MTBX [0x2C] = BT62 /* \_SB_.BT62 */
                MTBX [0x2D] = BT63 /* \_SB_.BT63 */
                MTBX [0x2E] = BT64 /* \_SB_.BT64 */
                MTBX [0x2F] = BT65 /* \_SB_.BT65 */
                MTBX [0x30] = BT66 /* \_SB_.BT66 */
                If (((BTRV == 0x02) || ((BTRV == 0x03) || (BTRV == 0x04))))
                {
                    MTBX [0x32] = BT71 /* \_SB_.BT71 */
                    MTBX [0x33] = BT72 /* \_SB_.BT72 */
                    MTBX [0x34] = BT73 /* \_SB_.BT73 */
                    MTBX [0x35] = BT74 /* \_SB_.BT74 */
                    MTBX [0x36] = BT75 /* \_SB_.BT75 */
                    MTBX [0x37] = BT76 /* \_SB_.BT76 */
                    MTBX [0x39] = BT81 /* \_SB_.BT81 */
                    MTBX [0x3A] = BT82 /* \_SB_.BT82 */
                    MTBX [0x3B] = BT83 /* \_SB_.BT83 */
                    MTBX [0x3C] = BT84 /* \_SB_.BT84 */
                    MTBX [0x3D] = BT85 /* \_SB_.BT85 */
                    MTBX [0x3E] = BT86 /* \_SB_.BT86 */
                }

                If (((BTRV == 0x02) || (BTRV == 0x04)))
                {
                    MTBX [0x40] = BT91 /* \_SB_.BT91 */
                    MTBX [0x41] = BT92 /* \_SB_.BT92 */
                    MTBX [0x42] = BT93 /* \_SB_.BT93 */
                    MTBX [0x43] = BT94 /* \_SB_.BT94 */
                    MTBX [0x44] = BT95 /* \_SB_.BT95 */
                    MTBX [0x45] = BT96 /* \_SB_.BT96 */
                    MTBX [0x47] = BTA1 /* \_SB_.BTA1 */
                    MTBX [0x48] = BTA2 /* \_SB_.BTA2 */
                    MTBX [0x48] = BTA3 /* \_SB_.BTA3 */
                    MTBX [0x4A] = BTA4 /* \_SB_.BTA4 */
                    MTBX [0x4B] = BTA5 /* \_SB_.BTA5 */
                    MTBX [0x4C] = BTA6 /* \_SB_.BTA6 */
                }

                If ((BTRV == 0x04))
                {
                    MTBX [0x4E] = BTB1 /* \_SB_.BTB1 */
                    MTBX [0x4F] = BTB2 /* \_SB_.BTB2 */
                    MTBX [0x50] = BTB3 /* \_SB_.BTB3 */
                    MTBX [0x51] = BTB4 /* \_SB_.BTB4 */
                    MTBX [0x52] = BTB5 /* \_SB_.BTB5 */
                    MTBX [0x53] = BTB6 /* \_SB_.BTB6 */
                    MTBX [0x55] = BTC1 /* \_SB_.BTC1 */
                    MTBX [0x56] = BTC2 /* \_SB_.BTC2 */
                    MTBX [0x57] = BTC3 /* \_SB_.BTC3 */
                    MTBX [0x58] = BTC4 /* \_SB_.BTC4 */
                    MTBX [0x59] = BTC5 /* \_SB_.BTC5 */
                    MTBX [0x5A] = BTC6 /* \_SB_.BTC6 */
                }
            }

            Return (MTBX) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT4.MTBX */
        }
    }
