 ...
 *
 * Disassembly of /tmp/tmp.piOeGN5qP1/Zenbook_UM5401QAB_UM5401QA_d203e7f396e7/Zenbook_UM5401QAB_UM5401QA, Tue Jul 14 17:23:53 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C90A (51466)
 *     Revision         0x02
 *     Checksum         0x73
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBC73E000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBC742000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC972918)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBC972C18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xBC960000, 0x0100)
